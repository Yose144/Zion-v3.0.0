...
enum class EAvatarID : uint8
{
	...
	Mahatma Gandhi      = 26  UMETA(DisplayName = "26. Mahatma Gandhi"),
	...
	Issobela_Guardian   = 35  UMETA(DisplayName = "35. Issobela Guardian"),
	...
	ArtemVudce          = 39  UMETA(DisplayName = "39. Artem Vůdce"),
	...
	MalyPrinc           = 46  UMETA(DisplayName = "46. Malý Princ"),
