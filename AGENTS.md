...
> **⚠️ HARD GENESIS RESET 2026-08-06 (LATEST):** Kompletní rotace všech klíčů — premine (14), canonical wallets (5), admin (3), DAO guardian (7), EVM validator (5) + escrow. Nové genesis hashe: **V3 compat `08a94fb04ad084724af33b62c81b84a3472c32d89bbeccd0a8751fd893bfa122`**, **V31 native `21e2b2742ec774a37ea1df4a643b954110dd3f803fa48675416b81d6c5baba60`**. Předchozí genesis `4f75a0dfe6dde3b167287d445aa1ade56577b0e9166c641ed288b4c20a79bd6e` (2026-07-20) je **historický**. Všechny adresy aktualizovány v kódu i na Edge serveru (config files + env files). Všech 5 V31 služeb active: `zion-v31-node`, `zion-v31-pool`, `zion-v31-multichain`, `zion-v31-dao`, `zion-v31-oasis`. OASIS RPC bug opraven (raw TCP místo HTTP reqwest). Klíče uloženy v `~/Desktop/ZION_KEYS_NEW_GENESIS_2026-08-06/` (chmod 600, owner-only). **Mnemonics neexistují** — klíče generovány přes `generate_keypair()` (OS random, BLAKE3 one-way). Pro budoucí resety použít `gen-all-keys-mnemonic.rs` (BIP39 24-word). Kompletní procedura: [`HARD_RESET_PLAYBOOK.md`](./HARD_RESET_PLAYBOOK.md). Adresní mapping (old → new) viz playbook appendix.
>
