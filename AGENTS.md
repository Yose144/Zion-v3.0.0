...
- **3.0.3 decimal fork — DEPLOYED (2026-06-27):** [`ZION_3.0.3_DECIMAL_FORK_PLAN.md`](./ZION_3.0.3_DECIMAL_FORK_PLAN.md) — Option E (in-place fork via migration block at H+1, preserves block hashes 0..H). Edge server deployed: MIGRATION_HEIGHT=17995, protocol 3.0.3, flowers_per_zion=1e6, all 13 services active. Rollback: DB backup at `edge-state.db.bak-3.0.3-cutover`.
