...
ZANO_OPTS = '--disable-cpu --algorithm progpow_zano --pool fr.zano.herominers.com:1110 --wallet ZxCj5kQhNdW7xtt4hDTotBPGUsWYKRdtdPTFXjzFpPpf6q42rCVXcYnTtHRYGj3pzz2LUqCnvVoRzFn9zfZdCSzC1CkBiHYrg --api-enable'
...
print('>> RESTORE: clear customMiner and set ZANO options')
api('PUT', f'/rig-groups/{GROUP}', {'customMiner': '', 'minerOptions': ZANO_OPTS})
time.sleep(2)
