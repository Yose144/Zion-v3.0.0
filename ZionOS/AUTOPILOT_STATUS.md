...
1. Pridat command history filtry (pending/acked/failed) + limit/offset.
2. Dopsat lightweight integration test pro retry/lease scenar.
3. Dovest hard fail/soft fail startup politiku dashboardu (env/cesty).
4. Rozsirit agent telemetry parser (hashrate/shares) z miner outputu.
