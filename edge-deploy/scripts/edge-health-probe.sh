...
SVCS=$(systemctl is-active zion-edge-node1 zion-edge-node2 zion-edge-pool zion-edge-bridge zion-edge-dao zion-edge-atomic-swap zion-edge-warp zion-edge-oasis zion-edge-miner zion-edge-agent zion-edge-dashboard zion-edge-dex zion-edge-python-dashboard zion-edge-watchdog zion-edge-backup zion-edge-maintenance 2>/dev/null | paste -sd ',')
