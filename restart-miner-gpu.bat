...
echo [START] Miner starting at %TIME%
...
echo [ENV] POOL=%ZION_POOL_ADDR% BACKEND=%ZION_GPU_BACKEND% WORK_SIZE=%ZION_GPU_WORK_SIZE%
V3\target\release\zion-miner.exe
echo [EXIT] Miner exited with code %ERRORLEVEL% at %TIME%
pause
