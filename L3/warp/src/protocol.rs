...
impl WarpMessage {
    ...
    pub fn signing_hash(&self) -> Vec<u8> {
        ...
        hasher.update(self.amount_atomic.to_le_bytes());
        hasher.update(self.fee_atomic.to_le_bytes());
...
mod tests {
    ...
    fn test_deposit_proof_serialization() {
        ...
        assert_eq!(parsed.amount_atomic, 1_000_000);
    }
