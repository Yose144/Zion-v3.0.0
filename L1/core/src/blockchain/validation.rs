...
pub fn max_timestamp_drift_for_network(network: NetworkType) -> u64 {
    match network {
        NetworkType::Testnet => MAX_TIMESTAMP_DRIFT_TESTNET,
        NetworkType::Mainnet => MAX_TIMESTAMP_DRIFT_MAINNET,
    }
}

pub fn max_timestamp_drift() -> u64 {
    max_timestamp_drift_for_network(get_network())
}
...
pub fn validate_block(
    ...
    if let Some(prev) = prev_block {
        ...
        let max_timestamp_drift = max_timestamp_drift();
