...
fn main() {
    ...
    c_build
        ...
        .warnings(false);
    apply_arch_flags(&mut c_build, &target_arch, &target_os);
    ...
    cpp_build
        ...
        .flag_if_supported("-fPIC")
        .warnings(false);
    apply_arch_flags(&mut cpp_build, &target_arch, &target_os);
    if target_os == "macos" {
...
fn apply_arch_flags(build: &mut cc::Build, arch: &str, _os: &str) {
    match arch {
        "aarch64" => {
