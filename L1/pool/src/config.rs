...
const FALLBACK_BTC_WALLET: &str = "bc1qvujra09wlsm35tmhc0v0fnxpsj0cuaq88hd8mw";
...
const FALLBACK_XMR_WALLET: &str = "42m86RBWf4PeuRf8P5rwA96XvmCKAfF77doWYJRv3KKAKrT8GTb5b3pbHTtaZsbJ4BERW1NHgh8WQgpAxAoEiXF82skcKsK";
...
pub struct StreamDynamicPoolEntry {
    ...
    #[serde(default)]
    pub proxy_listen: Option<String>,
    /// CPU threads dedicated to this coin (default 1 for CPU coins like VRSC)
    #[serde(default = "default_coin_threads")]
    pub threads: usize,
}
