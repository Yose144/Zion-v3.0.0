...
> **Aktuální verze:** 3.0.7 "Triple Stream All Green" plánování  
> **Další milníky:** 3.0.8 "Full Stack Stable" → 3.0.9 "Pre-Alpha Hardening" → 3.1.0 "Mainnet Alpha"  
> **Související:** [`3.0.7.md`](./3.0.7.md), [`TRIPLE_STREAM_ALL_GREEN_PLAN.md`](./TRIPLE_STREAM_ALL_GREEN_PLAN.md), [`StatusV3.md`](./StatusV3.md), [`ROADMAP.md`](./ROADMAP.md), [`AGENTS.md`](./AGENTS.md)
...
|-------|-------|-----|-----|---------------|
| **3.0.7** | Triple Stream All Green | Každý aktivní stream má ověřené accepted shares | 2026-07 | [`TRIPLE_STREAM_ALL_GREEN_PLAN.md`](./TRIPLE_STREAM_ALL_GREEN_PLAN.md) |
...
|---|------|----------|-----------|
| 1.1 | Dokit 3.0.7 All Green | Triple Stream | VRSC ≥95%, EPIC ≥1 accepted, ZION ≥99%, XMR má fallback |
