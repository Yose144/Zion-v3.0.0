...
start "ZION Node :: RPC 127.0.0.1:8443" cmd /k "cd /d %REPO_ROOT% && V3\target\release\node.exe"
timeout /t 5 /nobreak >nul

:: ── Spusteni miner ──────────────────────────────────────────────────────
echo [3/3] Spoustim ZION GPU Miner...
start "ZION GPU Miner :: 77.42.71.94:8444" cmd /k "cd /d %REPO_ROOT% && V3\target\release\zion-miner.exe"
...
echo  Node      : P2P 0.0.0.0:8333  RPC 0.0.0.0:8443
echo  Miner     : Pool 77.42.71.94:8444 (OpenCL AMD)
echo ===========================================================
echo.
pause
endlocal
