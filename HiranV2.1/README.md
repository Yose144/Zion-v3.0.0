...
- **`data/shards/`** — původní JSONL řádky oddělené podle tahů generování (`zion_train*.jsonl`, ...).
- **`data/hiran_curriculum_v2.1.jsonl`** — sloučené učivo (deduplikace; **v2 vzorky vyhrávají** nad starší vrstvou).
