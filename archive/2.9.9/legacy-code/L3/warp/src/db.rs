...
use crate::types::{WarpStatus, WarpTransfer};
        ...
        conn.execute(
            r#"INSERT OR REPLACE INTO transfers
               (id, status, source_chain, dest_chain, sender, recipient,
                amount_atomic, fee_atomic, memo, source_tx, dest_tx,
...
mod tests {
    use super::*;
    use crate::types::{ChainId, WarpTransfer};
    use uuid::Uuid;
    ...
    fn test_save_and_load() {
        ...
        assert_eq!(loaded.amount_atomic, 1_000_000_000);
