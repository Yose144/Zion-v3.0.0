...
private:
	...
	static constexpr int64 PRIZE_CEO = 1000000000LL;      // 1st place
	static constexpr int64 PRIZE_CCO =  500000000LL;      // 2nd place
	static constexpr int64 PRIZE_CAO =  250000000LL;      // 3rd place
