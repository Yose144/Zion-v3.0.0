...
impl Default for DaoConfig {
    fn default() -> Self {
        Self {
            ...
            l1_rpc_url: "http://91.98.122.165:8444/jsonrpc".into(),
            l1_rpc_backup: Some("http://127.0.0.1:8444/jsonrpc".into()),
            scan_interval_secs: 10,
            min_vote_weight: 1_000,
            finality_blocks: 6,
            proposal_threshold: 1_000_000_000_000, // 1 000 000 ZION
            quorum_percent: 10.0,
            ...
            daily_spend_limit: 100_000_000_000_000, // 100 000 000 ZION
