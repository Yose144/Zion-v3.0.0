...
**Verze: 0.2.0 | Datum: 17. února 2026**  
**Status: ✅ KÓDOVĚ KOMPLETNÍ — čeká na deploy + audit**  
...
2. ✅ Bridge relay crate (Rust) napsán
3. ✅ L1 bridge address přidán do core
4. ✅ Hardhat testy pro kontrakty (wZION.test.ts + ZIONBridge.test.ts)
5. ✅ ABI dekódování l1_recipient v evm_watcher.rs
6. ✅ L1 unlock TX implementace v relayer.rs
7. ✅ Bridge testnet config (config/bridge-testnet.toml)
8. ⬜ Deploy na Base Sepolia
9. ⬜ End-to-end test (lock → mint → burn → unlock)
...
*Poslední aktualizace: 17. únor 2026*
