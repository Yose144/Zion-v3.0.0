...
> **Poslední update:** 2026-05-22 (dashboard + Launch Day automation + GPU mining lokálně + mainnet ready pro odložené spuštění (TBD))
...
| **Launch Day** | ⭐ **Automatizace pro odložené spuštění (TBD)** |

### 6.3 Launch Day Tab (postponed (TBD), 12:00 UTC)
...
| [`MAINNET_LAUNCH_SEQUENCE.md`](./MAINNET_LAUNCH_SEQUENCE.md) | Kompletní launch plán odložen (TBD) |
