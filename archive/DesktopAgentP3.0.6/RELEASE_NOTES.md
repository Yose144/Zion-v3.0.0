# ZION Public Desktop Miner v3.2.0
...
|------|----------|--------|--------|
| `zion-public-miner-v3.2.0-mac-arm64.dmg` | macOS Apple Silicon | DMG | `1ec9d37f27d6b760256f23d911f825e1d11cdc6af4a21b9f581eda3d4e6a0e7c` |
| `zion-public-miner-v3.2.0-linux-x86_64.AppImage` | Linux x86_64 | AppImage | `c4bdb1b77409e2e00289c13f48f76b3a41c71b8867b11981de7b95c631c33767` |
| `zion-public-miner-v3.2.0-linux-amd64.deb` | Linux x86_64 | DEB | `42d3b02a6080b452600913bc3b48652bf5863ba0419a2102d4651d39e2ae8f15` |
| `zion-public-miner-v3.2.0-windows-x64.exe` | Windows x64 | NSIS installer | `fba2fc1ffa7e557a158bfe072c79740f70d4838a92b883762ed8f243f2cb5beb` |
| `zion-public-miner-v3.2.0-windows-x64.zip` | Windows x64 | Portable ZIP | `e1db933c2b8ddd900b10d29d1e895aab3edd94bc44bd879deed11cf10b1107c2` |
...
```bash
chmod +x zion-public-miner-v3.2.0-linux-x86_64.AppImage
./zion-public-miner-v3.2.0-linux-x86_64.AppImage
```
...
```bash
sudo dpkg -i zion-public-miner-v3.2.0-linux-amd64.deb
