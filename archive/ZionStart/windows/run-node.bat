...
:: ============================================================================
::  ZION Node - lokalni backup node (pripojuje se na Edge seed 62.171.141.136)
::  RPC  : 0.0.0.0:8443
::  P2P  : 0.0.0.0:8333
::  WS   : 0.0.0.0:8445
...
set ZION_SEED_PEERS=62.171.141.136:8333
:: Fallback (Tailscale VPN): set ZION_SEED_PEERS=62.171.141.136:8333
...
echo  Seed: 62.171.141.136:8333 (Edge public, Tailscale fallback 62.171.141.136)
