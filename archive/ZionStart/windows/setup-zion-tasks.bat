...
schtasks /create /tn "ZION-Start-Visible-Stack" /tr "C:\Users\yosef\Desktop\Zion\2.9.6-main\ZionStart\windows\start-all-visible.bat" /sc onlogon /rl highest /f
echo === Creating ZION-AutoBackup-15min (every 15 min) ===
schtasks /create /tn "ZION-AutoBackup-15min" /tr "C:\Users\yosef\Desktop\Zion\2.9.6-main\ZionStart\windows\backup-local-core.bat" /sc minute /mo 15 /f
echo === Done ===
