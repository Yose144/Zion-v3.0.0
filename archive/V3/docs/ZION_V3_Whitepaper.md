...
The wider ecosystem has Base Sepolia contract deployments in the current 2.9 line. In V3 codebase, L2 is represented by bridge/DAO/atomic-swap daemons and 6-decimal (flowers) accounting migration (updated 3.0.3 fork).
