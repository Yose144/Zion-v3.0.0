// Equihash 200,9 OpenCL kernel for Zcash (ZEC) mining.
//
// Adapted from silentarmy (https://github.com/mbevand/silentarmy)
// which was originally for Equihash 200,9 — this is the ORIGINAL parameter set.
//
// Equihash is a memory-hard PoW based on the generalized birthday problem
// (Wagner's algorithm). Parameters for ZEC: N=200, K=9
//   - 9 rounds of collision finding
//   - Blake2b hash function
//   - Solution size: 2^9 * 21 bits = 1344 bytes
//   - Memory requirement: ~256MB GPU VRAM (with NR_ROWS_LOG=20)
//
// References:
...
#include "equihash_200_9_param.h"
