      ...
      <div className="zion-container max-w-7xl relative z-10 space-y-16 pb-24">
          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
            <div className="space-y-5">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Link href="/docs" className="zion-rainbow-sub inline-flex items-center gap-2 px-6 py-3 text-sm font-semibold text-white" style={{ '--rc': '139, 92, 246' } as CSSProperties}>
            ...
            <div className="w-full lg:max-w-md space-y-3">
              <div className="zion-rainbow-sub p-5" style={{ '--rc': '147, 51, 234' } as CSSProperties}>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between zion-rainbow-sub p-3" style={{ '--rc': '245, 158, 11' } as CSSProperties}>
                    <div className="flex items-center gap-2 text-sm text-gray-300">
        ...
        >
            ...
            <div className="space-y-12">
              ...
              <section>
                ...
                {loading ? (
                  ...
                  <div className="zion-rainbow-card p-12 text-center" style={{ '--rc': '139, 92, 246' } as CSSProperties}>
            ...
            <div className="space-y-12">
              {treasury && (
                ...
                >
                  ...
                  <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    <div className="zion-rainbow-sub p-4" style={{ '--rc': '255, 215, 0' } as CSSProperties}>
              ...
              >
                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                  ...
                  <div className="zion-rainbow-sub p-4" style={{ '--rc': '249, 115, 22' } as CSSProperties}>
                ...
                {stats && (
                  <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    {[
                      ...
                      <div key={s.label} className="zion-rainbow-sub p-4" style={{ '--rc': '236, 72, 153' } as CSSProperties}>
              ...
              >
                ...
                <div className="grid gap-6 md:grid-cols-3">
                  {[
                    ...
                    <div key={node.level} className="zion-rainbow-sub p-5" style={{ '--rc': node.level === 'Koruna' || node.level === 'Crown' ? '147, 51, 234' : node.level === 'Srdce' || node.level === 'Heart' ? '6, 182, 212' : '245, 158, 11' } as CSSProperties}>
          ...
          {activeTab === 'roadmap' && (
            <motion.section
              ...
              viewport={{ once: true }}
              className="zion-rainbow-card p-8"
              style={{ '--rc': '245, 158, 11' } as CSSProperties}
            >
              <div className="flex flex-col gap-2 mb-6">
              ...
              <div className="grid gap-6 md:grid-cols-3">
                {phases.map((phase) => (
                  <div key={phase.title} className="zion-rainbow-sub p-6" style={{ '--rc': phase.title.includes('Fáze 1') || phase.title.includes('Phase 1') ? '147, 51, 234' : phase.title.includes('Fáze 2') || phase.title.includes('Phase 2') ? '6, 182, 212' : '16, 185, 129' } as CSSProperties}>
        ...
        >
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {quickLinks.map((link) => (
              <div key={link.label} className="zion-rainbow-sub p-5 hover:bg-white/5 transition-colors" style={{ '--rc': '139, 92, 246' } as CSSProperties}>
