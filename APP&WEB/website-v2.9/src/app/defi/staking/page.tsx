  ...
  return (
    <div className="pt-28 md:pt-32 pb-24 overflow-x-hidden">
      ...
      <div className="relative z-10 zion-container max-w-5xl space-y-14">
        ...
        {/* HERO */}
        <motion.section initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} style={{ '--rc': '34, 197, 94' } as React.CSSProperties} className="zion-rainbow-card rounded-3xl md:rounded-4xl bg-black/60 p-6 md:p-10">
