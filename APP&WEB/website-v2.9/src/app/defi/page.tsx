...
const DefiCopy = {
  ...
  wzionUsdtPrimaryPoolOnUniswapV: { cs: `wZION/USDT primární pool na Uniswap V3. Sekundární pooly WETH/USDC/SOL jsou inicializované, ale bez aktivní likvidity.`, en: `wZION/USDT primary pool on Uniswap V3. Secondary WETH/USDC/SOL pools are initialized but carry no active liquidity.` },
  ...
  wzionUsdtPoolOnPancakeswapV3An: { cs: `wZION/USDT pool na PancakeSwap V3 (deprecated, bez likvidity). Používej Uniswap V3.`, en: `wZION/USDT pool on PancakeSwap V3 (deprecated, no liquidity). Use Uniswap V3.` },
  ...
  l1Base55Validators: { cs: `L1 ↔ Base · 5 validátorů, threshold 4/5`, en: `L1 ↔ Base · 5 validators, 4/5 threshold` },
  ...
  wzionUsdtOnUniswapV3AndPancake: { cs: `wZION/USDT na Uniswap V3. Aktuální aktivní likvidita: 151,867 wZION + 19 USDT. PancakeSwap V3 pool je prázdný (deprecated).`, en: `wZION/USDT on Uniswap V3. Current active liquidity: 151,867 wZION + 19 USDT. PancakeSwap V3 pool is empty (deprecated).` },
