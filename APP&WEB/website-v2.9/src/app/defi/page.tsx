...
const DefiCopy = {
  ...
  defiHubEarlyBeta: { cs: `Multichain — fáze testování`, en: `Multichain — Testing Phase` },
  wzionContractsAreDeployedOnBas: { cs: `Multichain služby, bridge a DEX jsou v rané testovací fázi. Používejte pouze malé částky a očekávejte změny.`, en: `Multichain services, bridge, and DEX are in an early testing phase. Use only small amounts and expect changes.` },
