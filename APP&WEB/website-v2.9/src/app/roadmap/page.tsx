...
const t = {
  cs: {
    ...
    phase4Desc: 'Veřejný launch je odložen (TBD). Phase 1 Foundation je kompletní, ale pro veřejný start potřebujeme projít Maturity Gate (Maturitou), zajistit základní likviditu a sestavit tým dobrovolných vývojářů. Do té doby bude síť nadále v aktivním vývoji a testování.',
  ...
  en: {
    ...
    phase4Priority: '⏸️ P0 Blocker → On Hold',
    phase4Desc: 'The public launch is postponed (TBD). Phase 1 Foundation is complete, but a public start requires passing the Maturity Gate, securing basic liquidity, and assembling a team of volunteer developers. Until then the network remains in active development and testing.',
