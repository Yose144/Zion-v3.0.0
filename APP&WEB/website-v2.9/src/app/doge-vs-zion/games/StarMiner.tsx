              ...
              return (
                <button
                  ...
                  className={`w-full text-left rounded-lg border p-2.5 transition-all ${
                    affordable
                      ? 'border-emerald-500/30 bg-emerald-500/5 hover:bg-emerald-500/10 hover:border-emerald-500/50 cursor-pointer'
                      : 'border-white/10 bg-black/30 opacity-60 cursor-not-allowed'
                  }`}
                >
                  <div className="flex items-center gap-2.5">
                    <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-purple-500/15 border border-purple-500/30">
        ...
        <div className="flex flex-col items-center justify-center w-full lg:w-[340px]">
          <div className="relative zion-rainbow-card zion-rainbow-sub p-6 flex flex-col items-center" style={{ '--rc': '228, 30, 43' } as React.CSSProperties}>
            ...
            >
              ...
              <motion.div
                className="absolute inset-0 rounded-full"
                style={{ boxShadow: '0 0 30px 10px rgba(16,185,129,0.35)' }}
                ...
                <button
                  ...
                  className={`w-full text-left rounded-lg border p-2.5 transition-all ${
                    owned
                      ...
                      : affordable
                        ? 'border-purple-500/30 bg-purple-500/5 hover:bg-purple-500/10 hover:border-purple-500/50 cursor-pointer'
                        : 'border-white/10 bg-black/30 opacity-60 cursor-not-allowed'
                  }`}
                >
                  <div className="flex items-center gap-2.5">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-2">
                        <span className="text-xs font-bold text-white truncate">{cs ? def.nameCs : def.name}</span>
                        {owned && <span className="text-[10px] text-emerald-400 font-bold shrink-0">✓</span>}
                      </div>
                      <div className="flex items-center justify-between gap-2 mt-0.5">
                        <span className="text-[10px] text-slate-400 truncate">{cs ? def.descCs : def.desc}</span>
                        {!owned && (
                          <span className={`text-[11px] font-bold shrink-0 ${affordable ? 'text-amber-300' : 'text-slate-500'}`}>
