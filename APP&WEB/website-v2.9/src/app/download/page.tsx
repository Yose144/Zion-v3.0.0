        ...
        <section className="rounded-4xl border border-white/10 bg-black/60 p-10 backdrop-blur-xl">
          <div className="flex flex-col gap-6">
            ...
            <p className="text-lg text-gray-300">
              {cs ? `ZION CLI v3.0.1 — oficiální release s Core+Edge topologií. Jedna unifikovaná binárka obsahuje celý stack:` : `ZION CLI v3.0.1 — official release with Core+Edge topology. One unified binary contains the whole stack:`}{' '}
