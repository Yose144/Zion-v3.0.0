    ...
    <div className="zion-page text-white">
          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
            <div className="space-y-5">
              ...
              <div className="flex flex-wrap items-center gap-3 text-xs">
                <span className={`zion-badge ${escrowOnline ? 'zion-badge-green' : 'border-zion-purple/30 bg-zion-purple/10 text-zion-purple'}`}>
                  <span className={`h-2 w-2 rounded-full ${escrowOnline ? 'bg-zion-cyan animate-pulse' : 'bg-zion-purple'}`} />
            ...
            <div className="w-full lg:max-w-md space-y-3">
              <div className="zion-rainbow-sub p-5" style={{ '--rc': '228, 30, 43' } as CSSProperties}>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between zion-rainbow-sub p-3" style={{ '--rc': '228, 30, 43' } as CSSProperties}>
                  ...
                  <div className="flex items-center justify-between zion-rainbow-sub p-3" style={{ '--rc': '7, 137, 48' } as CSSProperties}>
                    ...
                    <span className={`font-mono ${escrowOnline ? 'text-zion-cyan' : 'text-zion-purple'}`}>
      ...
      <section className="zion-container relative z-10 mb-12">
        <AnimatePresence mode="wait">
                    ...
                    {generatedPreimage && (
                      <div className="space-y-2 text-xs font-mono">
                        <div className="zion-rainbow-sub p-2 relative" style={{ '--rc': '228, 30, 43' } as CSSProperties}>
                          ...
                          >
                            <Copy className={`h-3 w-3 ${copied === 'preimage' ? 'text-zion-cyan' : 'text-gray-400'}`} />
                          </button>
                        </div>

                        <div className="zion-rainbow-sub p-2 relative" style={{ '--rc': '228, 30, 43' } as CSSProperties}>
                          <div className="text-[9px] text-gray-500 uppercase">Hashlock (SHA-256)</div>
                          <div className="text-zion-cyan break-all pr-8 mt-1">{generatedHash}</div>
                          <button
                            onClick={() => handleCopy(generatedHash!, 'hash')}
                            className="zion-button-secondary absolute right-2 top-2 p-1.5"
                          >
                            <Copy className={`h-3 w-3 ${copied === 'hash' ? 'text-zion-cyan' : 'text-gray-400'}`} />
                          </button>
                        </div>
                      </div>
                    )}
                  ...
                  {generatedHash && initRecipient && (
                    <div className="zion-rainbow-sub p-4 space-y-2 text-xs" style={{ '--rc': '7, 137, 48' } as CSSProperties}>
                      ...
                      <div className="space-y-1.5 font-mono zion-rainbow-sub p-3 relative" style={{ '--rc': '228, 30, 43' } as CSSProperties}>
                        ...
                        <div><span className="text-gray-500">Memo:</span> <span className="text-zion-cyan break-all">{getSwapMemo()}</span></div>
                        <button
                          onClick={() => handleCopy(getSwapMemo(), 'memo')}
                          className="zion-button-secondary absolute right-2 top-2 p-1.5"
                        >
                          <Copy className={`h-3.5 w-3.5 ${copied === 'memo' ? 'text-zion-cyan' : 'text-gray-400'}`} />
                        </button>
                      </div>
                    </div>
                  )}
          ...
          {activeTab === 'manage' && (
            ...
            >
              <div className="flex items-center gap-3">
                <div className="zion-rainbow-sub p-3 text-zion-purple" style={{ '--rc': '228, 30, 43' } as CSSProperties}>
              ...
              <form className="space-y-4 max-w-3xl">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 font-mono text-white focus:border-zion-purple focus:outline-none text-xs"
              ...
              <div className="zion-rainbow-card p-6 md:p-8 space-y-4" style={{ '--rc': '7, 137, 48' } as CSSProperties}>
                ...
                <form onSubmit={handleSearch} className="flex gap-2">
                  <input
                    ...
                    className="flex-1 rounded-xl border border-white/10 bg-white/5 px-3 py-2 font-mono text-xs text-white focus:border-zion-cyan focus:outline-none"
                ...
                {searchError && <div className="text-xs text-zion-purple font-medium">{searchError}</div>}
      ...
      <section className="zion-container relative z-10 mb-12">
        ...
        >
          ...
          <div className="space-y-3">
            {faqs.map((f, i) => (
              <div key={i} className="zion-rainbow-sub" style={{ '--rc': '228, 30, 43' } as CSSProperties}>
                <button
