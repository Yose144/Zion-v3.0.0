    ...
    <div className="pt-28 pb-20 overflow-x-hidden">
      <div className="zion-container max-w-7xl space-y-12">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <Link href="/admin/algo-manager" className="group zion-rainbow-card p-6 hover:border-white/25" style={{ '--rc': '99, 102, 241' } as React.CSSProperties}>
            ...
            <div className="mt-6 inline-flex items-center gap-2 zion-tile px-4 py-3 text-sm font-semibold text-white group-hover:border-white/25">
              {lang === 'cs' ? 'Otevřít' : 'Open'}
              <span className="text-zion-cyan">→</span>
            </div>
          </Link>

          <Link href="/admin/pool-config" className="group zion-rainbow-card p-6 hover:border-white/25" style={{ '--rc': '99, 102, 241' } as React.CSSProperties}>
