...
function NetFAQSection({ cs }: { cs: boolean }) {
  ...
  const faqs = [
    ...
    { q: cs ? 'Je síť veřejně spuštěna?' : 'Is the network publicly launched?', a: cs ? 'V3 Mainnet je LIVE od 20. června 2026 (Summer Solstice). Core + Edge topology je operational, mining aktivní, bridge deployed na Base Mainnet.' : 'V3 Mainnet is LIVE since 20 June 2026 (Summer Solstice). Core + Edge topology is operational, mining active, bridge deployed on Base Mainnet.' },
  ];
  return (
