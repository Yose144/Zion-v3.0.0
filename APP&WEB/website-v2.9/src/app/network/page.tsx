...
function NetFAQSection({ cs }: { cs: boolean }) {
  ...
  const faqs = [
    ...
    { q: cs ? 'Jak se připojit jako miner?' : 'How to connect as a miner?', a: cs ? 'Stáhněte si XMRig nebo Desktop Agent a použijte stratum+tcp://77.42.71.94:4444 jako pool adresu. Detaily najdete v Connection Guides výše.' : 'Download XMRig or the Desktop Agent and use stratum+tcp://77.42.71.94:4444 as the pool address. See the Connection Guides section above for details.' },
