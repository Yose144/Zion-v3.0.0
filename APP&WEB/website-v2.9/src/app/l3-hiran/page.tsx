      ...
      <div className="zion-container max-w-7xl space-y-16">
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-5">
            {modelCards.map((model) => (
              <div key={model.name} className="zion-rainbow-sub p-6" style={{ '--rc': '6, 105, 40' } as React.CSSProperties}>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {ragArch.map((item) => (
              <div key={item.title} className="zion-rainbow-sub p-5" style={{ '--rc': '6, 105, 40' } as React.CSSProperties}>
        ...
        >
          ...
          <div className="grid gap-5 md:grid-cols-3">
            {marketplace.map((item) => (
              <div key={item.name} className="zion-rainbow-sub p-5" style={{ '--rc': '6, 105, 40' } as React.CSSProperties}>
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link href="/warp" className="zion-rainbow-sub inline-flex items-center gap-2 px-6 py-3 text-sm font-semibold text-white hover:bg-white/10 transition-colors" style={{ '--rc': '6, 105, 40' } as React.CSSProperties}>
