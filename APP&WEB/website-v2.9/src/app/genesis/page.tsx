      ...
      <div className="relative overflow-hidden border-b border-white/10 bg-linear-to-b from-zion-purple/10 via-transparent to-transparent">
        <div className="zion-container py-20 relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="mb-6 zion-rainbow-sub px-6 py-4 text-left text-sm text-amber-100" style={{ '--rc': '251, 191, 36' } as React.CSSProperties}>
              {cs
      ...
      <div className="zion-container py-12">
        ...
        <div className="flex gap-8">
          ...
          <div className="flex-1 max-w-3xl mx-auto">
            {!cs && (
              <div className="mb-10 zion-rainbow-sub px-5 py-4 text-sm text-gray-300" style={{ '--rc': '251, 191, 36' } as React.CSSProperties}>
            ...
            <section id="predmluva" className="mb-20 scroll-mt-24">
              ...
              <div className="prose prose-invert prose-lg max-w-none space-y-6 text-center">
                ...
                <div className="my-12 zion-rainbow-sub p-8" style={{ '--rc': '251, 191, 36' } as React.CSSProperties}>
            ...
            <section id="chapter-4" className="mb-20 scroll-mt-24">
              ...
              <div className="prose prose-invert prose-lg max-w-none space-y-6 text-center">
                ...
                <div className="my-8 zion-rainbow-sub p-8" style={{ '--rc': '251, 191, 36' } as React.CSSProperties}>
            ...
            <section id="chapter-5" className="mb-20 scroll-mt-24">
              ...
              <div className="prose prose-invert prose-lg max-w-none space-y-6 text-center">
                ...
                <div className="my-12 zion-rainbow-sub p-10" style={{ '--rc': '251, 191, 36' } as React.CSSProperties}>
            ...
            <section id="chapter-7" className="mb-20 scroll-mt-24">
              ...
              <div className="prose prose-invert prose-lg max-w-none space-y-6 text-center">
                ...
                <div className="space-y-6 max-w-2xl mx-auto">
                  <div className="p-6 zion-rainbow-sub" style={{ '--rc': '251, 191, 36' } as React.CSSProperties}>
            ...
            <section id="chapter-8" className="mb-20 scroll-mt-24">
              ...
              <div className="prose prose-invert prose-lg max-w-none space-y-6 text-center">
                <div className="my-12 zion-rainbow-sub p-12" style={{ '--rc': '251, 191, 36' } as React.CSSProperties}>
                ...
                <ul className="space-y-3 list-none pl-0 flex flex-col items-center max-w-2xl mx-auto">
                  <li className="flex items-center gap-3 w-full justify-between px-6 py-3 zion-rainbow-sub" style={{ '--rc': '251, 191, 36' } as React.CSSProperties}>
                ...
                <div className="my-16 zion-rainbow-sub p-12" style={{ '--rc': '251, 191, 36' } as React.CSSProperties}>
            ...
            <div className="text-center py-20 border-t border-white/10">
              ...
              <div className="flex flex-wrap gap-4 justify-center mt-8">
                <div className="px-6 py-3 zion-rainbow-sub" style={{ '--rc': '251, 191, 36' } as React.CSSProperties}>
