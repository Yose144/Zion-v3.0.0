      ...
      <div className="zion-container py-12">
        ...
        <div className="lg:hidden mb-6">
          <button
            ...
            className="w-full flex items-center justify-between px-4 py-3 rounded-xl border border-white/10 bg-black/60 backdrop-blur-xl text-white hover:border-zion-gold/30 transition-colors"
          >
          ...
          {mobileMenuOpen && (
            <div className="mt-4 border border-white/10 rounded-2xl p-4 bg-black/80 backdrop-blur-xl space-y-2">
          ...
          <div className="flex-1 max-w-3xl mx-auto">
            ...
            <section id="predmluva" className="mb-20 scroll-mt-24">
              ...
              <div className="prose prose-invert prose-lg max-w-none space-y-6 text-center">
                ...
                <div className="my-12 p-8 rounded-2xl border border-zion-gold/30 bg-zion-gold/5 backdrop-blur-xl">
            ...
            <section id="chapter-1" className="mb-20 scroll-mt-24">
              ...
              <div className="prose prose-invert prose-lg max-w-none space-y-6 text-center">
                ...
                <div className="my-12 p-8 rounded-2xl border border-zion-purple/30 bg-zion-purple/5 backdrop-blur-xl">
                  <p className="text-lg italic text-center text-gray-300 leading-relaxed">
            ...
            <section id="chapter-4" className="mb-20 scroll-mt-24">
              ...
              <div className="prose prose-invert prose-lg max-w-none space-y-6 text-center">
                ...
                <div className="my-8 p-8 rounded-2xl border border-zion-gold/30 bg-zion-gold/5 backdrop-blur-xl">
            ...
            <section id="chapter-6" className="mb-20 scroll-mt-24">
              ...
              <div className="prose prose-invert prose-lg max-w-none space-y-6 text-center">
                ...
                <div className="my-8 p-8 rounded-2xl border border-zion-cyan/30 bg-zion-cyan/5 backdrop-blur-xl">
                  <p className="text-base text-gray-300 leading-relaxed">
                ...
                <div className="my-8 p-8 rounded-2xl border border-zion-purple/30 bg-zion-purple/5 backdrop-blur-xl">
                  <p className="text-base text-gray-300 leading-relaxed">
            ...
            <section id="chapter-7" className="mb-20 scroll-mt-24">
              ...
              <div className="prose prose-invert prose-lg max-w-none space-y-6 text-center">
                ...
                <div className="space-y-6 max-w-2xl mx-auto">
                  <div className="p-6 rounded-xl border border-zion-cyan/30 bg-zion-cyan/5 backdrop-blur-sm">
            ...
            <section id="chapter-8" className="mb-20 scroll-mt-24">
              ...
              <div className="prose prose-invert prose-lg max-w-none space-y-6 text-center">
                ...
                <ul className="space-y-3 list-none pl-0 flex flex-col items-center max-w-2xl mx-auto">
                  <li className="flex items-center gap-3 w-full justify-between px-6 py-3 rounded-lg bg-zion-gold/10 border border-zion-gold/30">
                  ...
                  <li className="flex items-center gap-3 w-full justify-between px-6 py-3 rounded-lg bg-zion-cyan/10 border border-zion-cyan/30">
                    <span className="flex items-center gap-2">
                  ...
                  <li className="flex items-center gap-3 w-full justify-between px-6 py-3 rounded-lg bg-zion-purple/10 border border-zion-purple/30">
                    <span className="flex items-center gap-2">
                ...
                <div className="my-12 p-10 rounded-2xl border-2 border-zion-gold/50 bg-linear-to-b from-zion-gold/20 to-zion-purple/10 backdrop-blur-xl">
