...
const WarpCopy = {
  ...
  evmWalletsDefiSwapDaoTreasuryL: { cs: `EVM peněženky, DeFi swap, DAO treasury, LP stakes, CEX listings`, en: `EVM wallets, DeFi swap, DAO treasury, LP stakes, CEX listings` },
  ...
  openDefiHub: { cs: `Otevřít DeFi Hub`, en: `Open DeFi Hub` },
        ...
        <motion.section initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="space-y-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {swapPairs.map((pair) => {
              ...
              const statusConfig = {
                live: { label: WarpCopy.live[cs ? 'cs' : 'en'], color: 'text-emerald-400', bg: 'bg-emerald-500/10', border: 'border-emerald-500/20', icon: CheckCircle2 },
                planned: { label: WarpCopy.planned[cs ? 'cs' : 'en'], color: 'text-cyan-400', bg: 'bg-cyan-500/10', border: 'border-cyan-500/20', icon: Clock },
                research: { label: WarpCopy.research[cs ? 'cs' : 'en'], color: 'text-amber-400', bg: 'bg-amber-500/10', border: 'border-amber-500/20', icon: Clock },
