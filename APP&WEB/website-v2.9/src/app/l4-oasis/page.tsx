      ...
      <div className="zion-container max-w-7xl space-y-16">
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-6">
            {avatarTypes.map((a) => (
              <div key={a.name} className="zion-rainbow-sub p-5" style={{ '--rc': '6, 105, 40' } as React.CSSProperties}>
          ...
          <div className="zion-rainbow-sub p-4 text-sm text-gray-400 font-mono" style={{ '--rc': '6, 105, 40' } as React.CSSProperties}>
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            {goldenEgg.map((stat) => (
              <div key={stat.label} className="zion-rainbow-sub p-4 text-center" style={{ '--rc': '6, 105, 40' } as React.CSSProperties}>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {features.map((f) => (
              <div key={f.title} className="zion-rainbow-sub p-5" style={{ '--rc': '6, 105, 40' } as React.CSSProperties}>
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link href="/terranova" className="zion-rainbow-sub inline-flex items-center gap-2 px-6 py-3 text-sm font-semibold text-white hover:bg-white/10 transition-colors" style={{ '--rc': '6, 105, 40' } as React.CSSProperties}>
