      ...
      <div className="relative mx-auto mt-12 max-w-5xl rounded-[40px] border border-white/10 bg-black/80 p-10 shadow-[0_30px_120px_rgba(8,8,20,0.65)]">
                  ...
                  <div className="relative">
                    ...
                    <div className="mt-4 space-y-3">
                      {node.guardians.map((guardian) => (
                        ...
                        >
                          <p className="font-semibold text-zion-gold">{guardian.package}</p>
                          <p>{guardian.amount}</p>
                        </div>
                      ))}
                    </div>
        ...
        <div className="relative mt-10 flex flex-wrap items-center justify-center gap-4 text-xs uppercase tracking-[0.3em] text-gray-300">
          <span className="inline-flex items-center gap-2">
            <span className="h-2.5 w-2.5 rounded-full bg-amber-300" /> Roots · Pizza Pack
          </span>
          <span className="inline-flex items-center gap-2">
            <span className="h-2.5 w-2.5 rounded-full bg-cyan-300" /> Heart · Lambo Pack
          </span>
          <span className="inline-flex items-center gap-2">
            <span className="h-2.5 w-2.5 rounded-full bg-fuchsia-300" /> Crown · Guardian Pack
          </span>
        </div>
      </div>
      <style jsx>{`
