  ...
  if (error) {
    return (
      <div className="rounded-2xl border border-zion-purple/20 bg-zion-purple/5 p-6 text-center">
        <p className="text-zion-purple text-sm">Failed to load DAO stats</p>
        <p className="text-gray-500 text-xs mt-2">{error}</p>
        <button
          onClick={fetchStats}
          className="mt-4 px-4 py-2 rounded-lg bg-zion-purple/20 hover:bg-zion-purple/30 text-zion-purple text-sm transition-colors"
        >
          Retry
        </button>
      </div>
