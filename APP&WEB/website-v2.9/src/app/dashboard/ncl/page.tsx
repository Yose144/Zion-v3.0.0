...
function rc(color: 'cyan' | 'purple'): React.CSSProperties {
  return { '--rc': color === 'cyan' ? '6, 105, 40' : '228, 30, 43' } as React.CSSProperties;
}
  ...
  return (
    <div className="text-white p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        ...
        {source === 'fallback' && (
          <div className="mt-3 inline-flex items-center gap-2 rounded-full border border-zion-gold/30 bg-zion-gold/10 px-4 py-1.5 text-xs text-zion-gold">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <Card style={rc('cyan')}>
          <div className="flex items-center gap-2 mb-3">
            <Activity size={14} className="text-zion-cyan" />
