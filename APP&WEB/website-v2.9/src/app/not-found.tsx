...
import { Home, ArrowLeft, Orbit, Search, Rocket } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-32">
      ...
      >
        ...
        {/* Title */}
        <p className="text-sm uppercase tracking-[0.4em] text-gray-500 mb-3">Signal Lost</p>
        <h1 className="text-7xl md:text-8xl font-bold text-gradient mb-4">404</h1>
        <p className="text-xl text-gray-300 mb-2">Tato stránka nebyla nalezena</p>
        <p className="text-sm text-gray-500 max-w-md mx-auto mb-10">
          Hledaná koordináta neexistuje v aktuálním WARP prostoru.
          Zkontrolujte URL nebo se vraťte na známou orbitu.
        </p>
