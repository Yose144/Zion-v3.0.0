  ...
  return (
    <div className="relative min-h-screen pb-24 overflow-x-hidden">
      ...
      <div className="relative z-10 zion-container max-w-[1400px] space-y-10 pt-6 pb-8">
        ...
        >
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-col gap-3">
              ...
              {sse.stats && (
                <div className="zion-rainbow-sub p-4 rounded-2xl" style={{ "--rc": "6, 105, 40" } as React.CSSProperties}>
        ...
        >
          <div className="zion-rainbow-card rounded-2xl bg-black/60 p-4 flex flex-wrap items-center gap-3" style={{ "--rc": "6, 105, 40" } as React.CSSProperties}>
        ...
        >
          ...
          <div className="zion-rainbow-card rounded-[28px] bg-black/60 overflow-x-auto overflow-y-hidden" style={{ "--rc": "6, 105, 40" } as React.CSSProperties}>
            {/* table header */}
