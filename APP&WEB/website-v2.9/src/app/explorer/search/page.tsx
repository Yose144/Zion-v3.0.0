    ...
    <Suspense fallback={
      <div className="pt-28 md:pt-32 pb-24">
        <div className="zion-container max-w-5xl animate-pulse space-y-10">
          <div className="zion-rainbow-card h-40" style={{ '--rc': '6, 105, 40' } as React.CSSProperties} />
          <div className="zion-rainbow-card h-60" style={{ '--rc': '6, 105, 40' } as React.CSSProperties} />
        </div>
      </div>
    }>
      <SearchResultsClient />
