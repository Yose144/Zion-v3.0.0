  ...
  return (
    <div className="relative min-h-screen pb-24 overflow-x-hidden">
      ...
      <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
        ...
        <div className="absolute left-1/2 top-0 h-48 w-full -translate-x-1/2 bg-linear-to-b from-rose-500/15 to-transparent" />
      </div>
      ...
      <div className="relative z-10 zion-container max-w-4xl space-y-10 pt-6 pb-8">
          ...
          <div className="zion-rainbow-card rounded-3xl bg-black/60 p-6 md:p-8" style={{ "--rc": "251, 113, 133" } as React.CSSProperties}>
            ...
            <div className="flex items-center gap-4 mt-6">
              <button
                ...
                className="flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-rose-500 to-zion-cyan text-white font-semibold text-sm hover:opacity-90 disabled:opacity-40 disabled:cursor-not-allowed transition shadow-lg shadow-rose-500/20"
              >
                {loading ? (
                  <>
        ...
        >
          <div className="zion-rainbow-card rounded-2xl bg-black/60 p-6" style={{ "--rc": "6, 182, 212" } as React.CSSProperties}>
