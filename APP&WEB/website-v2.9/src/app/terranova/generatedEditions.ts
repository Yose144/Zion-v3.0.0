  ...
  "final": [
    {
      ...
      "epigraphEn": "*\"Hiranyagarbhas samavartata agre.* *In the beginning there was the golden embryo.\"* — Rigveda 10.121.1, over 5,000 years old *\"Sarvaṃ khalvidaṃ brahma. All that exists is Brahman.\"* — Chandogya Upanishad 3.14.1 *\"The most important decision we make is whether we believe we live in a friendly or a hostile universe.\"* — Albert Einstein *\"The Golden Age does not begin on a date. It begins with a decision.\"* — ZION Genesis Block, January 1, 2026",
      "color": "#00BFFF",
      "rgb": "0,191,255",
      "sectionsCs": [
        {
    ...
    },
    {
      ...
      "sectionsEn": [
        ...
        {
          "body": "🟢 **REALITY 2026:** The Manifest was written on January 1, 2026 — the same day as the ZION Genesis block.\r\n\r\n\r\nThese words are technical specifications, not poetry."
        },
        {
