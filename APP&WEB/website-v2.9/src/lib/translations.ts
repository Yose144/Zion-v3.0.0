...
const t = {
  ...
  hero: {
    ...
    badge_chv4:     { cs: '3-node mesh · Praha + USA + Singapur', en: '3-node mesh · Prague + USA + Singapore' },
    tagline:        { cs: 'Nativní Rust blockchain s konsensem Proof of Work', en: 'Native Rust blockchain with Proof-of-Work consensus' },
    title_sub:      { cs: 'Kontrolovaný test mainnet · 3 nody · kanonický runtime v2.9.8 Ekam Deeksha', en: 'Controlled test mainnet · 3 nodes · canonical v2.9.8 Ekam Deeksha runtime' },
    description:    {
      cs: 'ZION TerraNova běží jako kontrolovaný V3 test mainnet s 3-node P2P rehearsal sítí (Praha, USA, Singapur), veřejným poolem, nativními mining binárkami a provozní telemetrií.',
      en: 'ZION TerraNova runs as a controlled V3 test mainnet with a 3-node P2P rehearsal network (Prague, USA, Singapore), a public pool, native mining binaries, and operational telemetry.',
    },
    ...
    signal_nodes:   { cs: 'Validátorová síť', en: 'Validator grid' },
    ...
    version_pill_rehearsal: { cs: '3-node rehearsal · Praha + USA + Singapur', en: '3-node rehearsal · Prague + USA + Singapore' },
