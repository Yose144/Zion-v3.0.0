...
const t = {
  ...
  hero: {
    ...
    title_sub:      { cs: 'Genesis Live · Edge server · canonical runtime v3.2.0 One Love · 6-decimal flowers', en: 'Genesis Live · Edge server · canonical runtime v3.2.0 One Love · 6-decimal flowers' },
    description:    {
