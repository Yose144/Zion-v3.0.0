...
const t = {
  ...
  /* ─── Hero ─── */
  hero: {
    badge_version:  { cs: 'V3 Mainnet · v2.9.9 Pure Code · Launch Countdown', en: 'V3 Mainnet · v2.9.9 Pure Code · Launch Countdown' },
    ...
    title_sub:      { cs: 'Mainnet launch countdown · 3 nody · canonical runtime v2.9.8 Ekam Deeksha', en: 'Mainnet launch countdown · 3 nodes · canonical runtime v2.9.8 Ekam Deeksha' },
    description:    {
      cs: 'ZION TerraNova se připravuje na veřejný mainnet launch 20. června 2026. Aktuálně běží řízený V3 test mainnet se 3-node P2P sítí (Praha, USA, Singapur), veřejným poolem, mining binárkami a provozní telemetrií.',
      en: 'ZION TerraNova is preparing for public mainnet launch on 20 June 2026. Currently running a controlled V3 test mainnet with a 3-node P2P network (Prague, USA, Singapore), public pool, mining binaries, and operational telemetry.',
    },
