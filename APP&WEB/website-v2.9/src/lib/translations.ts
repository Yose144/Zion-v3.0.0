...
const t = {
  ...
  nav: {
    ...
    defi:       { cs: 'Multichain',        en: 'Multichain' },
  ...
  hero: {
    ...
    description:    {
      cs: 'ZION TerraNova zůstává v aktivním vývoji. Veřejný launch je odložen (TBD). Projekt potřebuje širší tým dobrovolných vývojářů, splnění Maturity Gate (Maturita) a základní likviditu. Síť běží, ale není připravena na plnohodnotný veřejný start.',
      en: 'ZION TerraNova remains in active development. The public launch is postponed (TBD). The project needs a broader team of volunteer developers, a passed Maturity Gate, and basic liquidity. The network is running, but not yet ready for a full public start.',
    },
    ...
    signal_mainnet: { cs: 'Stav launchu', en: 'Launch status' },
    signal_loc:     { cs: 'Edge server + Edge server · ShareRelay', en: 'Edge server + Edge server · ShareRelay' },
    signal_target:  { cs: 'Odloženo (TBD)', en: 'Postponed (TBD)' },
    signal_status_l1: { cs: 'Genesis Launch active · runtime v3.2.0', en: 'Genesis Launch active · runtime v3.2.0' },
    signal_status_nodes: { cs: 'Edge server online', en: 'Edge server online' },
    signal_status_mainnet: { cs: 'Veřejný launch odložen', en: 'Public launch postponed' },
  ...
  countdown: {
    title: { cs: 'Veřejný launch odložen', en: 'Public launch postponed' },
    target_date: { cs: 'Cíl: odloženo (TBD)', en: 'Target: postponed (TBD)' },
    subtitle: {
      cs: 'Aktivní vývoj · Hledáme dobrovolné vývojáře · Maturity Gate · Likvidita',
      en: 'Active development · Seeking volunteer developers · Maturity Gate · Liquidity',
    },
  },
  ...
  features: {
    ...
    timeline: {
      ...
      ph3: {
        phase: { cs: 'Veřejný launch · odložen (TBD)', en: 'Public launch · postponed (TBD)' },
        detail: {
          cs: 'MainNet Genesis 11. 6. 2026 dokončen. Veřejný launch je odložen; nové datum oznámíme po splnění Maturity Gate, zajištění likvidity a sestavení týmu dobrovolných vývojářů.',
          en: 'MainNet Genesis 11 Jun 2026 complete. Public launch is postponed; a new date will be announced once the Maturity Gate is passed, liquidity is secured, and a volunteer developer team is in place.',
        },
      },
    },
  ...
  whitepapers: {
    ...
    hero_subtitle: {
      cs: 'Kanonická whitepaper dokumentace pro ZION TerraNova v3 — One Love 3.2.',
      en: 'Canonical whitepaper documentation for ZION TerraNova v3 — One Love 3.2.',
    },
    hero_description: {
