...
export const SITE_RELEASE_NAME = 'Zion Trinity · Triple Stream';
export const SITE_RELEASE_TAGLINE = 'Triple Stream';
export const SITE_RELEASE_LABEL = `${SITE_VERSION} "${SITE_RELEASE_NAME}, Mainnet Beta"`;
...
export const SITE_PUBLIC_LAUNCH_STATUS = 'Zion Trinity · Triple Stream, Mainnet Beta';
