...
const TreeOfLifeSwitch = dynamic(() => import('@/components/TreeOfLifeSwitch'), {
  ssr: false,
  loading: () => (
    <div className="flex min-h-[420px] items-center justify-center rounded-[28px] border border-white/10 bg-black/40 text-gray-400">
  ...
  return (
    <section id="tree-of-life" className="px-4 py-10 md:py-14 scroll-mt-28">
      <div className="zion-container space-y-6">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-base text-gray-300 md:text-lg">
              Scéna je nyní načítaná až na vyžádání. Homepage tím nepálí GPU hned po načtení, ale Tree of Life zůstává
              dostupný jako výrazný prvek, ne jako schovaná funkce.
            </p>
          </div>
          {!revealed && (
            <button
        ...
        {!revealed ? (
          <div className="relative overflow-hidden rounded-[32px] border border-white/10 bg-[radial-gradient(circle_at_top,rgba(18,25,52,0.75),rgba(3,4,10,0.96)_62%)] p-6 md:p-8">
            ...
            <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
              <div className="space-y-4">
                ...
                <p className="text-lg leading-relaxed text-gray-300">
                  Odlehčený režim drží homepage plynulou. Interaktivní 3D nebo classic tree se spustí až po kliknutí,
                  takže první render není blokovaný canvasy, dynamickými scénami ani fallback animacemi.
                </p>
                <div className="grid gap-3 sm:grid-cols-3">
                  <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                    <p className="text-xs uppercase tracking-[0.3em] text-gray-500">Mode</p>
                    <p className="mt-2 text-lg font-semibold text-white">On demand</p>
                  </div>
                  <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                    <p className="text-xs uppercase tracking-[0.3em] text-gray-500">Goal</p>
                    <p className="mt-2 text-lg font-semibold text-white">Fast first paint</p>
                  </div>
                  <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                    <p className="text-xs uppercase tracking-[0.3em] text-gray-500">Fallback</p>
                    <p className="mt-2 text-lg font-semibold text-white">Classic query ready</p>
                  </div>
                </div>
              </div>
