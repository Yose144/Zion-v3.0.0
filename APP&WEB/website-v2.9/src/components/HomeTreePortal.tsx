...
const TreeOfLifeSwitch = dynamic(() => import('@/components/TreeOfLifeSwitch'), {
  ssr: false,
  loading: () => (
    <div className="flex min-h-[420px] items-center justify-center zion-rainbow-card text-zion-gold" style={{ '--rc': '252, 209, 22' } as React.CSSProperties}>
    ...
    <section id="tree-of-life" className="px-4 py-8 scroll-mt-28">
      <div className="zion-container space-y-4">
        ...
        <div className="text-center space-y-2">
          <p className="text-xs font-semibold uppercase tracking-[0.3em] text-zion-cyan">
        ...
        {!revealed ? (
          ...
          >
            <div className="zion-rainbow-card relative overflow-hidden p-4" style={{ '--rc': '252, 209, 22' } as React.CSSProperties}>
              <div className="grid gap-4 lg:grid-cols-[1fr_1fr] lg:items-center">
                {/* Left: text */}
                <div className="space-y-3">
                  <div className="inline-flex items-center gap-2 rounded-full border border-zion-cyan/30 bg-zion-cyan/10 px-4 py-2 text-xs uppercase tracking-[0.3em] text-zion-cyan">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2 rounded-2xl bg-linear-to-r from-zion-purple via-zion-gold to-zion-cyan px-6 py-3 text-sm font-semibold text-white shadow-[0_0_40px_rgba(252,209,22,0.25)] transition-all hover:shadow-[0_0_60px_rgba(252,209,22,0.4)]"
                  >
                    ...
                    {paths.map(([from, to], i) => {
                      ...
                      return (
                        <line
                          ...
                          stroke={isHovered ? 'rgba(252, 209, 22, 0.65)' : 'rgba(252, 209, 22, 0.12)'}
