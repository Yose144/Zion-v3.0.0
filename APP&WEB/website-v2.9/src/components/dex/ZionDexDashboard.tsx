  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="relative overflow-hidden border-b border-zinc-800/50">
        <div className="absolute inset-0 bg-gradient-to-br from-zion-gold/5 via-transparent to-zion-cyan/5" />
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-10">
          ...
          >
            <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-4">
              <div className="p-3 bg-zion-gold/20 rounded-2xl w-fit">
                <Sparkles className="w-7 h-7 text-zion-gold" />
              </div>
              <div>
      ...
      <div className="border-b border-zinc-800/50 bg-zion-gold/5">
