    ...
    <div className="mt-4 p-4 bg-zinc-900/60 border border-zinc-700/30 rounded-xl">
      ...
      <div className="flex flex-col gap-2">
        {steps.map((step, i) => (
          <div key={i} className="flex items-center gap-3">
            {/* Step number */}
            <div className="flex-shrink-0 w-6 h-6 rounded-full bg-amber-500/20 border border-amber-500/40 flex items-center justify-center text-xs font-bold text-amber-500">
              {i + 1}
            </div>
      ...
      <div className="mt-3 pt-3 border-t border-zinc-700/30 grid grid-cols-2 gap-2 text-xs">
        <div className="flex justify-between">
          ...
          <span className="text-amber-400 font-medium">{expectedOutput}</span>
        </div>
        <div className="flex justify-between">
        ...
        <div className="flex justify-between">
          ...
          <span className={priceImpactBps > 100 ? 'text-orange-400' : 'text-zinc-300'}>
