  ...
  return (
    <div ref={ref} className={`pointer-events-none absolute inset-0 overflow-hidden ${className}`}>
      ...
      <motion.div style={{ x: nebulaX }} className="absolute inset-0">
        <div className="absolute left-[5%] top-[10%] h-[300px] w-[300px] rounded-full bg-zion-purple/10 blur-[80px]" />
        <div className="absolute left-[15%] top-[30%] h-[200px] w-[200px] rounded-full bg-zion-purple/8 blur-[60px]" />
        <div className="absolute right-[5%] top-[15%] h-[280px] w-[280px] rounded-full bg-zion-gold/8 blur-[80px]" />
        <div className="absolute right-[20%] top-[40%] h-[180px] w-[180px] rounded-full bg-zion-gold/6 blur-[60px]" />
      </motion.div>
      ...
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
        <motion.div
          className="h-[2px] w-[400px] bg-gradient-to-r from-zion-gold/0 via-white/30 to-zion-purple/0"
      ...
      <motion.div style={{ x: dogeX }} className="absolute left-[12%] top-1/2 -translate-y-1/2">
        <div className="relative h-32 w-32">
          <div className="absolute inset-0 rounded-full bg-zion-gold/15 blur-[40px]" />
          <motion.div
            className="absolute inset-4 rounded-full border border-zion-gold/30"
            animate={{ scale: [1, 1.15, 1], opacity: [0.3, 0.6, 0.3] }}
            transition={{ duration: 3, repeat: Infinity, ease: 'easeInOut' }}
          />
          <motion.div
            className="absolute inset-8 rounded-full bg-gradient-to-br from-zion-gold/20 to-zion-gold/10 blur-md"
      ...
      <motion.div style={{ x: zionX }} className="absolute right-[12%] top-1/2 -translate-y-1/2">
        <div className="relative h-32 w-32">
          <div className="absolute inset-0 rounded-full bg-zion-purple/15 blur-[40px]" />
          <motion.div
            className="absolute inset-4 rounded-full border border-zion-purple/30"
            animate={{ scale: [1, 1.15, 1], opacity: [0.3, 0.6, 0.3] }}
            transition={{ duration: 3, repeat: Infinity, ease: 'easeInOut', delay: 0.5 }}
          />
          <motion.div
            className="absolute inset-8 rounded-full bg-gradient-to-br from-zion-purple/20 to-zion-purple/10 blur-md"
            animate={{ scale: [1, 1.2, 1] }}
      ...
      <motion.div style={{ x: ringX, y: ringY }} className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
        ...
        >
          ...
          <circle cx="100" cy="100" r="75" fill="none" stroke="rgba(6,105,40,0.2)" strokeWidth="0.5" />
        </motion.svg>
        <motion.svg
          viewBox="0 0 200 200"
