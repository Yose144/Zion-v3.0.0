...
const GenesisGardenPreview = dynamic(() => import('./GenesisGardenPreview'), {
  ssr: false,
...
export default function GenesisGardenPreviewLazy({
  lang = 'cs',
  className = '',
}: {
  lang?: 'cs' | 'en';
  ...
  return <GenesisGardenPreview lang={lang} className={`h-[420px] md:h-[520px] ${className}`} />;
}
