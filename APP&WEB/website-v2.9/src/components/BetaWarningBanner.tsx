      ...
      <div className="flex items-start gap-3 rounded-2xl border border-zion-gold/25 bg-zion-gold/[0.06] px-4 py-3 backdrop-blur-sm">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-sm text-amber-200/90 leading-relaxed">
            {cs ? (
              <>
                <strong className="font-semibold text-zion-gold">Mainnet Beta</strong> — síť může obsahovat chyby. Těžba a transakce probíhají na vlastní nebezpečí. Neneseme odpovědnost za ztrátu prostředků. Oficiální veřejný launch: 31. prosince 2026.
              </>
            ) : (
              <>
                <strong className="font-semibold text-zion-gold">Mainnet Beta</strong> — the network may contain bugs. Mining and transactions are at your own risk. We are not liable for any loss of funds. Official public launch: December 31, 2026.
              </>
            )}
          </p>
        </div>
