  ...
  return (
    <div className="py-20 px-4">
      <div className="zion-container">
        ...
        {/* ── Main results table ─────────────────────────────── */}
        <div className="zion-rainbow-card overflow-hidden mb-16" style={{ '--rc': '6, 105, 40' } as React.CSSProperties}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {FINDINGS.map((f, i) => {
              ...
              return (
                <div
                  key={i}
                  className="zion-rainbow-sub p-6 hover:bg-white/[0.04] transition-colors" style={{ '--rc': '6, 105, 40' } as React.CSSProperties}
                >
        ...
        <div className="zion-rainbow-card p-6 mb-16" style={{ '--rc': '6, 105, 40' } as React.CSSProperties}>
