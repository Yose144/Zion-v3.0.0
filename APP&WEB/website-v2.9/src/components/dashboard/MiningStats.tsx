        ...
        <>
          ...
          <div className="rounded-xl border border-white/10 bg-white/5 p-4 space-y-3">
            <div className="flex items-center justify-between text-xs">
              ...
              <span className={`inline-flex items-center gap-1.5 ${miner.online ? 'text-green-400' : 'text-gray-500'}`}>
                <span className={`h-2 w-2 rounded-full ${miner.online ? 'bg-green-400 animate-pulse' : 'bg-gray-600'}`} />
