        ...
        <div className="min-h-screen flex items-center justify-center px-4 bg-black text-white">
          <div className="text-center max-w-lg space-y-6">
            <div className="mx-auto w-20 h-20 rounded-full border border-zion-gold-500/30 bg-zion-gold-500/10 flex items-center justify-center">
              <svg className="w-10 h-10 text-zion-gold-400" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-zion-gold-600 to-zion-gold-500 text-black font-semibold hover:opacity-90 transition"
            >
              Obnovit stránku
            </button>
          </div>
