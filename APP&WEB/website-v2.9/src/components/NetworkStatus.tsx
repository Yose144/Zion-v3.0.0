  ...
  return (
    <div className={["space-y-6", className].filter(Boolean).join(" ")}>
      ...
      <div
        ...
        style={{ '--rc': status.summary.inSync ? '52, 211, 153' : '252, 209, 22' } as React.CSSProperties}
      >
