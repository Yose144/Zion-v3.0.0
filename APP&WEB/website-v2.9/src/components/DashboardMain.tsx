...
function Card({ children, className = '', variant = 'cyan' }: { children: React.ReactNode; className?: string; variant?: 'cyan' | 'purple' }) {
  const rc = variant === 'purple' ? '228, 30, 43' : '6, 105, 40';
  return (
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 py-2.5 rounded-2xl bg-gradient-to-r from-zion-gold to-zion-gold text-black text-sm font-semibold shadow-lg shadow-zion-gold/20 transition-transform hover:-translate-y-0.5 disabled:opacity-50"
                  >
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="space-y-5">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Stat label="Network HR"    value={fmtHashrate(m?.chain?.network_hashrate)}       icon={Globe}          color="#066928" />
            ...
            return (
              <Card key={p.id}>
                ...
                <div className="mt-4 flex items-center gap-6 text-xs">
                  <div><span className="text-gray-500">Yes: </span><span className="font-mono text-zion-cyan">{p.yes_votes.toLocaleString()}</span></div>
                  <div><span className="text-gray-500">No: </span><span className="font-mono text-zion-purple">{p.no_votes.toLocaleString()}</span></div>
                </div>
...
function WalletTab() {
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="space-y-5">
      {error && (
        <div className="rounded-xl border border-zion-purple/20 bg-zion-purple/10 p-4 text-sm text-zion-purple">{error}</div>
      )}
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                {copyOk && <span className="text-[10px] text-zion-cyan">Copied</span>}
              </div>
            </div>
            <div className="flex items-center gap-3">
            ...
            {wallets.map((w) => (
              ...
              >
                ...
                <button
                  ...
                  className="p-2 hover:bg-zion-purple/10 rounded-xl text-zion-purple transition shrink-0"
                  title="Delete"
                >
                  <Trash2 size={14} />
                </button>
      ...
      <div className="flex gap-1 overflow-x-auto pb-1">
        {(['overview','create','import','send','export'] as const).map((t) => (
          <button key={t} onClick={() => { setSubTab(t); setExportedSecret(''); setTxResult(''); }}
            ...
            style={subTab === t ? { '--rc': '6, 105, 40' } as React.CSSProperties : undefined}>
        ...
        <Card>
          {activeWallet ? (
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-2 p-3 zion-rainbow-sub" style={{'--rc': '6, 105, 40'} as React.CSSProperties}>
      ...
      {subTab === 'create' && (
        <Card>
          ...
          <div className="space-y-3 max-w-md">
            ...
            <button onClick={handleCreate} disabled={loading} className="px-5 py-2.5 rounded-2xl bg-gradient-to-r from-zion-gold to-zion-gold text-black text-sm font-semibold shadow-lg shadow-zion-gold/20 transition-transform hover:-translate-y-0.5 disabled:opacity-50">
          ...
          <Card>
            ...
            <div className="space-y-3 max-w-lg">
              ...
              <button onClick={handleImportMnemonic} disabled={loading}
                className="px-5 py-2.5 rounded-2xl bg-gradient-to-r from-zion-cyan to-zion-purple text-white text-sm font-semibold shadow-lg shadow-zion-cyan/20 transition-transform hover:-translate-y-0.5 disabled:opacity-50">
          ...
          <Card variant="purple">
            ...
            <div className="space-y-3 max-w-lg">
              ...
              <button onClick={handleImportPrivateKey} disabled={loading}
                className="px-5 py-2.5 rounded-2xl bg-gradient-to-r from-zion-purple to-zion-purple text-white text-sm font-semibold shadow-lg shadow-zion-purple/20 transition-transform hover:-translate-y-0.5 disabled:opacity-50">
      ...
      {subTab === 'send' && (
        <Card>
          <h3 className="text-sm font-semibold text-white mb-4 flex items-center gap-2"><Send size={14} className="text-zion-cyan" /> Send ZION</h3>
          {!activeWallet ? (
            ...
            <div className="space-y-3 max-w-lg">
              <div>
                ...
                <input type="text" value={sendTo} onChange={(e) => setSendTo(e.target.value)} placeholder="zion1..."
                  className="w-full rounded-xl bg-black/40 border border-white/10 p-3 text-sm text-white placeholder:text-gray-600 outline-none focus:border-zion-cyan/40 font-mono" />
              </div>
              ...
              <button onClick={handleSend} disabled={loading}
                className="px-5 py-2.5 rounded-2xl bg-gradient-to-r from-zion-cyan to-zion-cyan text-white text-sm font-semibold shadow-lg shadow-zion-cyan/20 transition-transform hover:-translate-y-0.5 disabled:opacity-50">
                {loading ? 'Sending...' : 'Send Transaction'}
              </button>
              {txResult && <p className="text-xs text-zion-cyan font-mono break-all">{txResult}</p>}
            </div>
          )}
        </Card>
      )}
        ...
        <Card>
          ...
          {!activeWallet ? (
            ...
            <div className="space-y-3 max-w-lg">
              ...
              {exportedSecret && (
                <div className="p-3 zion-rainbow-sub" style={{'--rc': '6, 105, 40'} as React.CSSProperties}>
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          ...
          {activeWallet && (
            <div className="flex items-center gap-3 shrink-0">
              <div className="flex items-center gap-2 px-3 py-1.5 zion-rainbow-sub" style={{'--rc': '6, 105, 40'} as React.CSSProperties}>
              ...
              <button onClick={disconnect} className="p-2 rounded-xl border border-white/10 hover:border-zion-purple/40 hover:bg-zion-purple/10 transition-colors" title="Disconnect">
