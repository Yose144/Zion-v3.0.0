...
export const NEWS_ARTICLES: NewsArticle[] = [
  {
    ...
    summary: {
      cs: 'Plánovaný veřejný launch je odložen (TBD). CoinGecko listing neprošel, projekt zůstává ve vývoji a hledáme tým dobrovolných vývojářů. Veřejný start bude možný až po Maturity Gate (Maturitě) a zajištění základní likvidity. Nové datum neoznámíme, dokud nebudeme připraveni.',
      en: 'The planned public launch is postponed (TBD). The CoinGecko listing was not approved, the project remains in development, and we are looking for a team of volunteer developers. A public start will only be possible after passing the Maturity Gate and securing basic liquidity. No new date will be announced until we are ready.',
    },
  ...
  },
  {
    ...
    summary: {
      cs: 'Spustili jsme jednotný onboarding pro ZION TerraNova: příběh, whitepaper, technická fakta a návod k těžbě v jednom dokumentu. Včetně nové jednostránkové FAQ a aktuálního časového rámce: poslední genesis 8. 8. 2026, Mainnet Launch odložen (TBD), OASIS preview s 400+ světy. One love, one chain, one road.',
      en: 'We launched the unified ZION TerraNova onboarding: story, whitepaper, technical facts, and mining guide in one document. Plus a new single-page FAQ and the updated timeline: final genesis 8 August 2026, Mainnet Launch postponed (TBD), OASIS preview with 400+ worlds. One love, one chain, one road.',
    },
    href: '/onboard?v=2',
    homepage: false,
  },
...

  {
    ...
    summary: {
      cs: 'ZION v3.0.6-beta "Trinity, Mainnet Beta" je venku. Miner pro Linux x86_64/ARM64, macOS Apple Silicon/Intel a Windows. Stáhni z GitHub Releases, vytvoř peněženku a začni těžit na oficiální pool. Veřejný launch je odložen (TBD).',
      en: 'ZION v3.0.6-beta "Trinity, Mainnet Beta" is out. Miner for Linux x86_64/ARM64, macOS Apple Silicon/Intel, and Windows. Download from GitHub Releases, create your wallet, and start mining to the official pool. Public launch is postponed (TBD).',
    },
  ...
  },
  {
    ...
    tagColor: 'text-zion-purple',
    title: {
      cs: 'TerraNova Genesis 3.0.1 — MainNet spuštěn 11. 6. 2026 · veřejný launch odložen (TBD)',
      en: 'TerraNova Genesis 3.0.1 — MainNet launched 11 Jun 2026 · public launch postponed (TBD)',
    },
    summary: {
      cs: 'Hard reset Genesis řetězce byl úspěšně proveden. Síť je stabilní, Edge server topologie běží, pool a mining jsou aktivní. Veřejný přístup pro všechny je odložen (TBD).',
      en: 'The Genesis chain hard reset was successfully completed. The network is stable, Edge server topology is running, pool and mining are active. Public access is postponed (TBD).',
    },
    href: '/terranova',
    homepage: false,
  },
