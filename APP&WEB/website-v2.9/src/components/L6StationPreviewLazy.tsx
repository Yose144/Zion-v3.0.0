...
const L6StationPreview = dynamic(() => import('./L6StationPreview'), {
  ssr: false,
...
export default function L6StationPreviewLazy({
  lang = 'cs',
  className = '',
}: {
  lang?: 'cs' | 'en';
  ...
  return <L6StationPreview lang={lang} className={`h-[420px] md:h-[520px] ${className}`} />;
}
