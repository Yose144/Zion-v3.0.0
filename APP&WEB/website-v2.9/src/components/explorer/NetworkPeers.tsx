  ...
  return (
    ...
    >
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        {stats.map((stat) => (
          <div key={stat.label} className="zion-rainbow-sub p-4" style={{ '--rc': '252, 209, 22' } as React.CSSProperties}>
        ...
        <div className="space-y-3 max-h-96 overflow-y-auto pr-1">
          ...
          {loading && (
            <div className="space-y-3">
              {[...Array(4)].map((_, idx) => (
                <div key={idx} className="animate-pulse zion-rainbow-sub p-4" style={{ '--rc': '252, 209, 22' } as React.CSSProperties}>
