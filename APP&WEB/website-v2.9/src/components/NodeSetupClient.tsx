...
const cliCommands = [
  ...
  { cmd: "zion-node --peers 77.42.31.72:8334,195.201.31.201:8334", desc: "Manual peer list" },
          ...
          <div className="space-y-3">
            {[
              ...
              },
              {
                ...
                a: "Verify firewall allows TCP 8334. Try manual peers: `--peers 77.42.31.72:8334,195.201.31.201:8334`. Check DNS resolution.",
              },
              {
                q: "Sync stuck / slow",
