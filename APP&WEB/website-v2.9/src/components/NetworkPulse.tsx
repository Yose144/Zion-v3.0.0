    ...
    <div className="zion-rainbow-card p-6 space-y-4" style={{ '--rc': '7, 137, 48' } as React.CSSProperties}>
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          {trend === 'up' && <TrendingUp className="w-4 h-4 text-zion-cyan" />}
          {trend === 'down' && <TrendingUp className="w-4 h-4 text-zion-purple rotate-180" />}
          <span className={`text-sm font-semibold ${
            trend === 'up' ? 'text-zion-cyan' : trend === 'down' ? 'text-zion-purple' : 'text-gray-400'
          }`}>
      ...
      <div className="grid grid-cols-3 gap-3 pt-2">
        ...
        <div className="text-center">
          ...
          <div className="flex items-center justify-center gap-1">
            <Zap className="w-3 h-3 text-zion-cyan animate-pulse" />
