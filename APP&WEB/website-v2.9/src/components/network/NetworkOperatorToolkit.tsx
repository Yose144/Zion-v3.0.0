      ...
      <div className="grid gap-5 lg:grid-cols-3">
        ...
        <div className="zion-rainbow-sub p-6" style={{ '--rc': '6, 182, 212' } as React.CSSProperties}>
          ...
          <div className="space-y-2.5 text-sm">
            <a href="/api/network" target="_blank" rel="noreferrer" className="zion-rainbow-sub p-3 flex items-center justify-between" style={{ '--rc': '6, 182, 212' } as React.CSSProperties}>
              <span className="font-mono text-xs text-gray-200">/api/network</span>
              <Download className="h-3.5 w-3.5 text-zion-gold" />
            </a>
            <a href="/api/health" target="_blank" rel="noreferrer" className="zion-rainbow-sub p-3 flex items-center justify-between" style={{ '--rc': '6, 182, 212' } as React.CSSProperties}>
              <span className="font-mono text-xs text-gray-200">/api/health</span>
              <Download className="h-3.5 w-3.5 text-zion-gold" />
            </a>
            <Link href="/monitoring" className="zion-rainbow-sub p-3 flex items-center justify-between" style={{ '--rc': '6, 182, 212' } as React.CSSProperties}>
            ...
            <Link href="/docs#live-index" className="zion-rainbow-sub p-3 flex items-center justify-between" style={{ '--rc': '6, 182, 212' } as React.CSSProperties}>
