  ...
  const charts: ChartData[] = useMemo(
    () => [
      ...
      },
      {
        ...
        data: blockTimeData,
        color: '#a855f7',
        icon: <Timer className="h-4 w-4 text-zion-purple" />,
        unit: 's',
  ...
  return (
    <section className="zion-rainbow-card p-8" style={{ '--rc': '6, 105, 40' } as React.CSSProperties}>
      ...
      <div className="grid gap-5 lg:grid-cols-3">
        {charts.map((chart) => (
          <div key={chart.label} className="zion-rainbow-sub p-5 flex flex-col" style={{ '--rc': '6, 105, 40' } as React.CSSProperties}>
