      ...
      <div className={embedded ? "space-y-10" : "zion-container max-w-7xl space-y-10"}>
            ...
            <div className="relative z-[1] flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
              ...
              <div className="flex shrink-0 items-center justify-center">
                <div className="relative">
                  <div className="absolute inset-0 rounded-full bg-zion-purple/20 blur-3xl" />
                  <div className="relative grid h-28 w-28 place-items-center rounded-3xl border border-zion-purple/30 bg-zion-purple/10">
                    <TrendingUp className="h-12 w-12 text-zion-purple" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="relative z-[1]">
            <div className="mb-6 flex items-center justify-between">
              <h2 className="flex items-center gap-2 text-lg font-semibold text-white">
                <Gauge className="h-5 w-5 text-zion-purple" />
            ...
            <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
              ...
              <Field label={PoolCalculatorCopy.yourHashrate[cs ? 'cs' : 'en']} hint={PoolCalculatorCopy.eG18K2M1G[cs ? 'cs' : 'en']}>
                <input
                  ...
                  placeholder="18 K"
                  className="rounded-xl border border-white/10 bg-white/5 px-3 py-2.5 text-sm text-white outline-none transition-colors focus:border-zion-purple/50 w-full"
                />
            ...
            <div className="mt-6 flex flex-wrap items-center gap-2">
              ...
              {HARDWARE_PRESETS.map((hw) => (
                <button
                  ...
                  className="inline-flex items-center gap-1.5 rounded-lg border border-white/10 bg-white/5 px-2.5 py-1.5 text-xs text-gray-300 transition-colors hover:border-zion-purple/40 hover:text-white"
                >
            ...
            <div className="mt-4 flex items-center gap-2 text-xs text-gray-500">
              <span className={`inline-block h-2 w-2 rounded-full ${loading ? 'bg-zion-gold' : poolStats ? 'bg-zion-cyan' : 'bg-gray-600'}`} />
              {loading
        ...
        >
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <ResultCard
              style={purpleStyle}
              icon={<Coins className="h-4 w-4 text-zion-purple" />}
            ...
            <ResultCard
              style={purpleStyle}
              icon={<Zap className="h-4 w-4 text-zion-gold" />}
            ...
            <ResultCard
              style={purpleStyle}
              icon={<DollarSign className="h-4 w-4 text-zion-cyan" />}
            ...
            <ResultCard
              style={purpleStyle}
              icon={<Server className="h-4 w-4 text-zion-purple" />}
                    ...
                    return (
                      <tr
                        ...
                        className={`border-b border-white/5 transition-colors ${
                          isSelected ? 'bg-zion-purple/10' : 'hover:bg-white/[0.03]'
                        }`}
                      >
                        <td className="py-3 pr-4">
                          <div className="flex items-center gap-2">
                            ...
                            {isSelected && (
                              <span className="rounded bg-zion-purple/20 px-1.5 py-0.5 text-[10px] font-medium text-zion-purple">
                        ...
                        <td className={`py-3 pr-4 font-mono font-semibold ${hw.netMonth >= 0 ? 'text-zion-cyan' : 'text-zion-purple'}`}>
                          {fmtUsd(hw.netMonth)}
                        </td>
                      </tr>
                    );
        ...
        >
          ...
          <div className="zion-rainbow-sub p-6" style={purpleStyle}>
            <div className="relative z-[1]">
              <div className="mb-4 flex items-center justify-between">
                ...
                <span className="font-mono text-sm text-zion-cyan">${zionPrice.toFixed(6)}</span>
              </div>
              <div className="flex flex-col items-center justify-center gap-3 rounded-xl border border-white/[0.06] bg-white/[0.02] py-10">
                <span className="text-4xl font-bold font-mono text-zion-cyan">
                  ${zionPrice.toFixed(6)}
                </span>
          ...
          <div className="zion-rainbow-sub p-6" style={purpleStyle}>
            <div className="relative z-[1]">
              <div className="mb-4 flex items-center justify-between">
                <h3 className="flex items-center gap-2 text-base font-semibold text-white">
                  <Activity className="h-4 w-4 text-zion-purple" />
                  {PoolCalculatorCopy.profitabilityTimeline365d[cs ? 'cs' : 'en']}
                </h3>
                {breakEvenDay !== null && (
                  <span className="rounded-full bg-zion-purple/20 px-2.5 py-1 text-xs text-zion-purple">
