  ...
  return (
    <g transform={`translate(${cx}, ${cy}) rotate(${angle + 90})`}>
      ...
      <path
        ...
        style={{ filter: active ? 'drop-shadow(0 0 6px rgba(111,255,240,0.7))' : 'none' }}
      />
      {/* inner chevron */}
      <path
    ...
    <div className="flex flex-col items-center gap-5">
      ...
      >
        <svg viewBox="-210 -210 420 420" className="h-full w-full" style={{ overflow: 'visible' }}>
          <defs>
            ...
            <radialGradient id="centerGlow" cx="50%" cy="50%" r="50%">
              <stop offset="0%" stopColor="rgba(111,255,240,0.3)" />
          ...
          {/* Pulsing rings */}
          <circle r={105} fill="none" stroke="rgba(111,255,240,0.12)" strokeWidth={1} opacity={0.4}>
          ...
          <circle r={95} fill="none" stroke="rgba(139,92,246,0.1)" strokeWidth={0.5}>
        ...
        <div className={`absolute inset-0 rounded-full transition-opacity duration-500 pointer-events-none ${hovered ? 'opacity-100' : 'opacity-0'}`}>
          <div className="absolute inset-0 rounded-full bg-[radial-gradient(circle_at_center,rgba(111,255,240,0.08),transparent_70%)]" />
        </div>
      </motion.div>
      ...
      >
        ...
        >
          ...
          <div className="flex flex-col">
            <span className="text-sm font-bold text-emerald-300 tracking-wide">ZION Oasis</span>
