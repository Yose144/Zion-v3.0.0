            ...
            <div className="px-6 py-5">
              ...
              {zionWallet.initialized && zionWallet.wallets.length === 0 && (
                <div className="text-center py-8">
                  <AlertCircle className="h-12 w-12 text-yellow-500/60 mx-auto mb-3" />
                      ...
                      {zionWallet.wallets.map((w) => (
                        ...
                        >
                          ...
                          {w.keyType === 'trezor' || w.keyType === 'ledger' ? (
                            <span className="text-[8px] text-yellow-500/60 uppercase">HW</span>
                          ) : null}
                        </button>
                      ))}
                    </div>
              ...
              {activeWallet && !zionWallet.isHardwareWallet && (
                <form onSubmit={handleSubmit}>
                  ...
                  {error && (
                    <div className="mb-4 rounded-lg border border-red-500/20 bg-red-500/5 px-3 py-2 flex items-start gap-2">
