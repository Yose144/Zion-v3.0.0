...
Poznámka pro aktuální stav:
- minimálně přepnout `@`, `*`, `www`, `api`, `explorer`, `mining`, `testnet` na `91.98.122.165`
- přidal jsem i `pool` a `seed1`, protože na nový host teď míří i pool / seed role
- po DNS změně čekat na propagaci TTL 3600 a pak znovu ověřit `dig +short zionterranova.com`
