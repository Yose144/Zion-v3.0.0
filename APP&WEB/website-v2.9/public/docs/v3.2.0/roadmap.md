...
The next horizon after 3.2. **"Nirvana" is an aspirational architectural target, not a committed release date.** It represents the grand unification of the whole technological-spiritual ZION ecosystem.
...
| Version | Notes |
|---|---|
| 3.1 (Mainnet Alpha) | First production cutover, mainnet topology |
...
| 3.0.3 | DeFi run and fee-market hardening |

---

*For live status see the [Network](/network) page and the [Explorer](/explorer). The canonical 3.2 forward plan and the 3.3 "Nirvana" blueprint are tracked in the ZION repository and on the [Roadmap](/roadmap) page.*
