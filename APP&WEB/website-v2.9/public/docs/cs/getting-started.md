...
Rozběhni ZION node za méně než 10 minut.
...
Data zůstanou v Docker volumes. Pro smazání dat použij `docker compose down -v`.
...
Binárky pro svůj OS najdeš na stránce [Download](https://www.zionterranova.com/download) nebo přímo v [GitHub Releases](https://github.com/Zion-TerraNova/2.9.6/releases).
