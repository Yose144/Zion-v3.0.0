...
Tento návod vysvětluje, jak stáhnout veřejný ZION CLI, ověřit jej a začít těžit na živém mainnetu.
...
- **L2 kontrakty** — DeFi, DAO, bridge a atomic-swap kontrakty v Solidity.
...
Porovnejte vypsaný hash s hodnotou v `SHA256SUMS.txt`.

---

## 4. První spuštění — interaktivní nastavení
...
3. **Pool** — volitelné lokální nastavení poolu (většina uživatelů se připojí k veřejnému poolu).
...
Nód se připojí k výchozím seed peerům a synchronizuje od genesis. Po synchronizaci můžete těžit proti lokálnímu nódu:
...
- Aktuální výšku bloku a stav synchronizace
...
- **Neinvestujte prostředky, které si nemůžete dovolit ztratit.** Není záruka, že nebude současný chain znovu resetován, i když hard reset z července 2026 byl explicitně poslední plánovaný reset a genesis je nyní deklarován jako permanentní.
- **Uchovejte seed phrase peněženky v bezpečí.** Ztracené klíče nelze obnovit.
- **Sledujte aktualizace.** Nové vydání CLI se objeví na stejné GitHub releases stránce.
...
Binárky budou v `V3/target/release/`. Potřebujete Rust ≥ 1.78 a standardní nástroje pro sestavení.
