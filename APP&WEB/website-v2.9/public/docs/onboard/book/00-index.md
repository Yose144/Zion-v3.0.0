...
1. **Příběh** — fikce, otevřeně přiznaná jako fikce. Postavy jsou archetypy, ne historická tvrzení o tom, co se skutečně stalo. Nikdo netvrdí, že se Ježíš, Buddha a Krišna doopravdy sešli pod fíkem.
2. **Ověřitelná fakta** — krátký box na konci každé epizody, který odděluje mýtus od kódu. Co je v boxu, se dá zkontrolovat na běžící síti, v repozitáři nebo ve whitepaperu. Co je v příběhu nad rámec boxu, je vyprávění, ne tvrzení.

Tohle rozdělení není formalita. Je to **jádro upřímnosti** téhle řady: příběh smí být krásný, ale fakta o síti musí být přesná. Když se ty dvě věci nesmí splést, čtenář může věřit oběma zvlášť — příběhu jako příběhu, faktům jako faktům.

---

## Jak číst tuto řadu

| # | Epizoda | Postava / motiv | Kniha, ze které vychází |
|---|---|---|---|
...
**Zkrácená marketingová verze pro širokou veřejnost:** [`Onboarding.md`](/onboard) — jeden dokument, který celou řadu shrnuje do jednoduché pozvánky s prvními kroky.
...
- **Není náhradou technického whitepaperu.** Kde příběh mluví o algoritmu, odměně nebo hard capu, čísla odpovídají [technickému whitepaperu 3.1](/whitepapers#technical-cz) a běžící síti — ne naopak.
