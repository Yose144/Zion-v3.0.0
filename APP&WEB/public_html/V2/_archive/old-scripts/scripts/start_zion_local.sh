#!/usr/bin/env bash
#
# ZION 2.7.5 Simple Local Stack Launcher
# Spustí blockchain node a mining pool lokálně v background
#

set -e

echo "🚀 ZION 2.7.5 Simple Local Stack"
echo "================================="

# Konfigurace
ZION_ROOT="/media/maitreya/ZION1"
VENV_PATH="/home/maitreya/zion_local_deployment/venv"
LOG_DIR="/home/maitreya/zion_local_deployment/logs"
...
blockchain = NewZionBlockchain(
    db_file='$LOG_DIR/../db/blockchain.db',
    enable_p2p=True, 
    p2p_port=$P2P_PORT,
    enable_rpc=True,
...
echo ""
echo "🎉 ZION 2.7.5 Local Stack Running!"
echo ""
echo "📋 Process IDs:"
