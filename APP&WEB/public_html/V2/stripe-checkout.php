...
if ($isPresale) {
    ...
    $items = $data['items'];
    $shippingPrice = (int)($data['shippingPrice'] ?? 0);
    ...
    foreach ($items as $item) {
        $lineItems[] = [
            'price_data' => [
                ...
                'unit_amount' => (int)($item['price'] * 100), // Stripe používá haléře
            ],
...
$stripeData = [
    ...
    'cancel_url' => ($data['cancelUrl'] ?? null) ?: (SITE_URL . '/V2/cart.html?cancelled=1'),
    'metadata' => [
        'order_id' => $orderId,
    ],
    'locale' => 'cs',
