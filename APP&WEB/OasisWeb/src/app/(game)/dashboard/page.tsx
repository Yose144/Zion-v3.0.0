      ...
      {player && (
        <>
          <motion.div
            initial={{ opacity: 0, y: 12 }}
            animate={{ opacity: 1, y: 0 }}
            className="mb-6 rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm"
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">
                  Consciousness: <span className="text-oasis-gold font-semibold">{player.level}</span>
                </p>
              </div>
            </div>
          </motion.div>
