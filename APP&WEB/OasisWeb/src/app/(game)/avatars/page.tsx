...
export default function AvatarsPage() {
  ...
  return (
    <section>
      ...
      <div className="mb-6 grid gap-3 rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-sm sm:grid-cols-2 lg:grid-cols-4">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {filtered.map((avatar) => (
          <motion.button
            ...
            whileTap={{ scale: 0.99 }}
            className="rounded-2xl border border-white/10 bg-white/5 p-5 text-left backdrop-blur-sm transition-colors hover:border-oasis-cyan/40"
          >
