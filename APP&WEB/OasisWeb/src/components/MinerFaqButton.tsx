  ...
  return (
    ...
    >
      <Link
        ...
        className="group flex items-center gap-2 rounded-full border border-white/10 bg-[#05060f]/85 px-3 py-2 text-sm font-bold text-white shadow-2xl backdrop-blur-xl transition hover:border-oasis-cyan/30 hover:bg-oasis-cyan/10 sm:px-4 sm:py-2.5"
      >
