...
const NEON_COLORS = [
  { hex: '#078930', label: 'Cyan' },
  { hex: '#e41e2b', label: 'Magenta' },
  { hex: '#fcd116', label: 'Gold' },
  { hex: '#078930', label: 'Emerald' },
  { hex: '#e41e2b', label: 'Crimson' },
  { hex: '#e41e2b', label: 'Violet' },
];
      ...
      >
        <AnimatePresence mode="wait">
          <motion.div
            ...
            >
              <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-[#fcd116]/30 bg-[#fcd116]/10 px-3 py-1 text-xs font-bold tracking-wider text-[#fcd116]">
                <Rocket size={12} />
                CHOOSE YOUR PATH
              </div>
                ...
                {ARCHETYPES.map((a) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="mb-3 text-xs leading-snug text-white/80">
                        {a.desc}
                      </p>
