...
export default function LanguageSwitcher() {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-1.5 rounded-lg border border-white/15 bg-black/75 px-2 py-1.5 text-[10px] font-semibold text-gray-300 transition-all hover:border-white/30 hover:bg-black hover:text-white"
