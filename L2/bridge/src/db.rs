    ...
    fn init_tables(&self) -> Result<()> {
        self.conn.execute_batch(
            ...
            CREATE TABLE IF NOT EXISTS evm_burns (
                ...
                amount_wzion     TEXT NOT NULL,
                amount_l1_atomic INTEGER NOT NULL,
    ...
    pub fn get_pending_burns(&self) -> Result<Vec<EvmBurnEvent>> {
        ...
        let rows = stmt.query_map([], |row| {
            Ok(EvmBurnEvent {
                ...
                amount_wzion: row.get(5)?,
                amount_l1_atomic: row.get(6)?,
...
mod tests {
    ...
    fn sample_lock(tx_hash: &str) -> L1LockEvent {
        L1LockEvent {
            ...
            amount_atomic: 5_000_000_000, // 5000 ZION
            amount_wzion: "5000000000000000000000".into(),
    ...
    fn sample_burn(burn_id: &str) -> EvmBurnEvent {
        EvmBurnEvent {
            ...
            amount_wzion: "1000000000000000000000".into(), // 1000 wZION
            amount_l1_atomic: 1_000_000_000,
    ...
    fn test_insert_and_query_lock() {
        ...
        assert_eq!(pending[0].amount_atomic, 5_000_000_000);
    ...
    fn test_insert_and_query_burn() {
        ...
        assert_eq!(pending[0].amount_l1_atomic, 1_000_000_000);
    }
