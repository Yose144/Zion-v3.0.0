...
- Dashboard UI/UX update do V31 hotov, nasazen na Edge (`zion-edge-python-dashboard` active, `/health` OK). V31 banner KPIs integrovány přímo do `app.py` `/api/status` a full dashboardu (`/dashboard`).
