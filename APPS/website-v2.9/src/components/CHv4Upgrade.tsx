...
const statusColors: Record<string, string> = {
  ...
  upgraded: 'bg-cyan-500/15 text-cyan-300',
  new: 'bg-pink-500/15 text-pink-300',
};
  ...
  return (
    <section className="relative py-32 px-4 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[600px] rounded-full bg-violet-600/8 blur-3xl" />
        <div className="absolute right-0 top-0 w-[400px] h-[400px] rounded-full bg-pink-500/6 blur-3xl" />
      </div>
      ...
      <div className="zion-container relative z-10">
        ...
        <motion.div
          ...
          className="zion-panel max-w-3xl mx-auto p-6 md:p-8 space-y-6"
        >
          ...
          <div className="grid grid-cols-[1fr_auto_auto_auto] gap-x-6 gap-y-3">
            ...
            <div className="text-xs uppercase tracking-widest text-cyan-400 text-right">CHv4</div>
            ...
            {improvements.map((row) => (
              <>
                ...
                <div key={`aft-${row.label}`} className="text-sm text-cyan-300 py-2 border-t border-white/5 text-right font-mono">{row.after}</div>
