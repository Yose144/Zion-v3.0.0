...
> **Provozní poznámka (2026-03-12):** Aktuální live testnet běží na jednom veřejném hostu Zion2 (91.98.122.165) s interními seed kontejnery, na 2.9.8 Deeksha kanonické cestě. Dřívější 3-node topologie Helsinki/USA/Asia je archivována.
...
|--------|------|--------|------|
| Zion2 (Primary) | `91.98.122.165:8334` | Německo (Hetzner) | Veřejný host + pool + web |
