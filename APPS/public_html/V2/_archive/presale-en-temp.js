...
const PRESALE_CONFIG = {
    ...
    tokenPrice: 0.008, // EUR per ZION token
    tokenPriceEur: 0.008,
    eurToCzk: 25,
    ...
    packages: {
        ...
        standard: {
            ...
            priceCzk: 12490,
            priceEur: 499,
            baseTokens: 62375, // 499 EUR / 0.008
            bonus: 0.20
        },
        premium: {
            name: 'Premium Pack',
            priceCzk: 24990,
            priceEur: 999,
            baseTokens: 124875, // 999 EUR / 0.008
            bonus: 0.30
        }
    }
};
...
amount = parseFloat(input?.value) || 0;
    ...
    const bonusRate = getBonusRate(a
    }
    
    const bonusRate = getBonusRate(eurAmount);
    const baseTokens = Math.floor(eurAmount / PRESALE_CONFIG.tokenPrice);
