...
# Use standard SRBMiner from SMOS marketplace with ZANO
...
print('>> RESTORE: use standard SRBMiner with ZANO (no customMiner)')
api('PUT', f'/rig-groups/{GROUP}', {'customMiner': '', 'minerOptions': SRBMINER_ZANO})
time.sleep(2)
