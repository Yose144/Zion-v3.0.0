...
> **Účel tohoto dokumentu:** Vysokoúrovňová časová osa a navigační rozcestník. Detailní pravomoci, důkazy a statusové štítky jsou v [`MiseAmenti/`](./MiseAmenti/README.md).
>
...
>
> **Vývojový horizont:** 3.3.0 "Nirvana" (Global Assimilation / Attention) — cíl, nikoli dosažený release; status a evidence v [`MiseAmenti/07-Registr-Dukazu.md`](./MiseAmenti/07-Registr-Dukazu.md).
>
