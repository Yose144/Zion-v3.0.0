/*
 * DeekshaLite Optimized — OpenCL Kernel (Energy-Efficient, Summer Mode)
 *
 * Pipeline (must match CPU deeksha_lite_optimized.rs exactly):
 ...
 *        Phase C: 32 random reads (reduced from 64)
 *   3. AES-128 CTR mix: 2 full rounds + 1 final round (3 total)
 *        key=s2[0..16], counter=nonce_le||s2[16..24]
 *        XOR result with s2[0..32]
 *   4. Keccak256(s3)  → final hash[32]
 *
 * Constants (must match deeksha_lite_optimized.rs):
...
#define PASSES           2
#define RANDOM_READS     32       /* reduced from 64 for power efficiency */
#define AES_FULL_ROUNDS  2        /* 2 full + 1 final = AES_ROUNDS=3 */

/* ========================================================================== */
/* Keccak-f[1600] — canonical implementation, GCN/RDNA safe                   */
/* ========================================================================== */
...
/* ========================================================================== */
/* Step 2A: Fill scratchpad (128 KiB = 4096 × 32B)                            */
/* ========================================================================== */
...
/* ========================================================================== */
/* Step 2C: Random read mix — 32 reads (energy-efficient)                     */
/* ========================================================================== */
...
/* ========================================================================== */
/* Step 3: AES-128 CTR mix — 2 full rounds + 1 final (AES_ROUNDS=3)          */
/* ========================================================================== */

void aes128_mix_lite(__private const uchar seed[32], ulong nonce, __private uchar out[32])
{
    uchar key[16];
    ...
    /* 2 full rounds + 1 final = AES_ROUNDS=3 */
...
/* ========================================================================== */
/* Main kernel — DeekshaLite Optimized (Energy-Efficient)                     */
/* ========================================================================== */

__kernel void deeksha_lite_optimized_mine(
