/*
 * DeekshaLite Fire Org — OpenCL Kernel (Original Winter Heater)
 *
 * Pipeline (must match deeksha_fire_org CPU lib.rs exactly):
...
/*                                                                             */
/* Matches CPU lib.rs step4_thermal_loop_enhanced() exactly.                  */
...
/* ========================================================================== */
/* Main kernel — DeekshaLite Fire Org (Winter Heater)                         */
/* ========================================================================== */

__kernel void deeksha_lite_fire_org_mine(
