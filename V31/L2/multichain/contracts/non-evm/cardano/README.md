...
The WARP adapter (`V31/L2/multichain/src/warp/adapter/cardano.rs`) uses the combined hex string:
```
...
After deployment, update `V31/L2/multichain/src/warp/adapter/cardano.rs`:
