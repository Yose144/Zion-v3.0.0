...
```bash
cd V31/L2/multichain/docker/lightning
docker compose up -d
```
...
```bash
cd V31/L2/multichain/scripts/lightning
./get_macaroon.sh
```
...
- `V31/L2/multichain/src/warp/adapter/lightning.rs` — WARP Lightning adapter
- `V31/L2/multichain/src/warp/lightning_signer.rs` — LND REST client
- `V31/L2/multichain/src/warp/bolt11.rs` — BOLT11 invoice parser
- `V31/L2/multichain/scripts/lightning/` — Channel management scripts
