...
> **Datum:** 2026-08-03
> **Stav:** workspace builduje, **1861 testů procházejí**, 0 failed. Fáze A hotová, Fáze B partial.
...
- **[B.2] Pool completion** — 4/4 modules enabled:
...
- **[B.3] Miner AuxPoW merge** — Infrastructure ported:
  ...
  - ⏳ autonomous.rs (686 lines) — needs zion_pool::PoolMessage, ExternalCoin methods
...
2. **autonomous.rs, parallel.rs** — need zion_pool::PoolMessage, zion_auxpow crate. Defer po ChainState port.
