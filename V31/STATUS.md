...
> **Update 2026-08-23 (L5/L6 fund trackers staged):** `zion-free-world` a `zion-issobella` jsou buildnuty a otestovány, systemd jednotky, edge-env, nginx proxy a health probe připraveny. Veřejný `MissionControlDashboard` a `StatusV3.md` aktualizovány. Edge deployment a start služeb je následující krok. Detail: [`docs/3.2/REPORTS/REPORT_2026-08-23_L5_L6_G10_DETAIL.md`](../docs/3.2/REPORTS/REPORT_2026-08-23_L5_L6_G10_DETAIL.md).
>
