...
async fn forward_share_to_upstream(
    ...
    // (job_id, nonce); upstream pools decide whether to accept multiple
    // shares per job. Pre-rejecting ZANO shares was throwing away valid
    // work and masking the real accept rate.
