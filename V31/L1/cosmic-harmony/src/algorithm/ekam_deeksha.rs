//! Ekam Deeksha — V3-beta-compatible canonical PoW (bit-identical to deeksha_lite_v1).
//!
...
// Known-answer test vectors for the V3 `deeksha_lite_v1` pipeline.
// Generated from the V3 CPU implementation and locked; if these change, the
...
mod tests {
    ...
    fn v3_beta_vector() {
        ...
        let expected = "b7836215e8baeea0acc245661ab6d0afc92b22bb216fdb598033b3ab84b38162";
        let got: String = hash.iter().map(|b| format!("{:02x}", b)).collect();
        assert_eq!(
            got, expected,
            "V3 beta vector mismatch: algorithm is not byte-identical to deeksha_lite_v1"
        );
    }
