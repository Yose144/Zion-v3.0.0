fn main() {
    ...
    let node_reward_addr = zion_core::crypto::canonical_address_for_label(pool_fee_label);
    ...
    println!("POOL_FEE_WALLET={}", node_reward_addr);
    println!("NODE_REWARD_WALLET={}", node_reward_addr);
