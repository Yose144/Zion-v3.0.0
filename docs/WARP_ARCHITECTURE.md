...
ZION L1 uses **6 decimals** — 1 ZION = `1,000,000` flowers
(`FLOWERS_PER_ZION = 10⁶`) *(updated to 6-decimal in 3.0.3 fork)*. The sub-unit is called **flowers**
...
| Cardano     | 6        | × 10⁰ (1:1)     | 1,000,000 lovelace    |
| Cosmos      | 6        | × 10⁰ (1:1)     | 1,000,000 uatom-equiv |
