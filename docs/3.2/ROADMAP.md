...
| **G10** | L5/L6 decision — treasury, humanitarian fund, Issobella governance | Must have defined run mode or explicit post-3.2 deferral | ✅ Decision made — activate as passive read-only fund trackers + DAO proposal bridge; not a 3.2.0 blocker; full disbursement/UI post-3.2 (see [`L5_L6_ACTIVATION_PLAN.md`](./L5_L6_ACTIVATION_PLAN.md)) |
...
| E9 | L5/L6 activation decision | product/ops | ✅ Decision recorded — activate as passive read-only fund trackers + DAO proposal bridge; not a 3.2.0 blocker (see [`L5_L6_ACTIVATION_PLAN.md`](./L5_L6_ACTIVATION_PLAN.md)) |
