# Detailní plán 3.2.1–3.2.9 "One Love"

> Tento dokument je detailním execution plánem pro všechny dílčí sekc 3.2.1–3.2.9 tracku ZION 3.2.0. Vychází z architektonického masterplánu [`V33_NIRVANA_MASTER_PLAN.md`](../../V33_NIRVANA_MASTER_PLAN.md) a živého provozního stavu v [`StatusV3.md`](../../StatusV3.md). Každý nárok se interpretuje podle značek ✅ hotové, 🔄 aktivně se testuje/běží, ❌ dosud nezačato nebo chybí evidence, a podle evidence v [`MiseAmenti/07-Registr-Dukazu.md`](../WP-Mainet/MiseAmenti/07-Registr-Dukazu.md).
...
- [`docs/3.2/3.2.1-L1-Core/Deeksha512.md`](3.2.1-L1-Core/Deeksha512.md)
- [`docs/3.2/3.2.1-L1-Core/DeekshaAsicResistance.md`](3.2.1-L1-Core/DeekshaAsicResistance.md)
- [`docs/3.2/3.2.1-L1-Core/DeekshaTuning.md`](3.2.1-L1-Core/DeekshaTuning.md)
- [`docs/3.2/3.2.1-L1-Core/NATIVE_L1_HTLC_REPORT.md`](3.2.1-L1-Core/NATIVE_L1_HTLC_REPORT.md)
...
- [`docs/3.2/3.2.2-Mining-and-Pool/REPORT_2026-08-21_ZION_MINER_V3.2_PUBLIC_BUILD.md`](3.2.2-Mining-and-Pool/REPORT_2026-08-21_ZION_MINER_V3.2_PUBLIC_BUILD.md)
- [`docs/3.2/3.2.2-Mining-and-Pool/WINDOWS_11_MINER_GUIDE.md`](3.2.2-Mining-and-Pool/WINDOWS_11_MINER_GUIDE.md)
- Detail: [`docs/3.2/AUTONOMOUS_PROFIT_ROUTER.md`](AUTONOMOUS_PROFIT_ROUTER.md)
...
| Web/Marketplace/OASIS/Dashboard → ZIS | ❌ | — | J1–J7 v [`docs/3.2/ROADMAP.md`](ROADMAP.md) |

**Dokumenty:**

- [`docs/3.2/3.2.3-Wallet-HTLC-and-Identity/ZIS_INTEGRATION_PLAN.md`](3.2.3-Wallet-HTLC-and-Identity/ZIS_INTEGRATION_PLAN.md)
- [`docs/3.2/3.2.3-Wallet-HTLC-and-Identity/REPORT_2026-08-18_DOCS_WALLET_DEPLOY.md`](3.2.3-Wallet-HTLC-and-Identity/REPORT_2026-08-18_DOCS_WALLET_DEPLOY.md)
- [`docs/3.2/3.2.3-Wallet-HTLC-and-Identity/REPORT_2026-08-23_ZIS_AUTH_INTEGRATION_COMPLETE.md`](3.2.3-Wallet-HTLC-and-Identity/REPORT_2026-08-23_ZIS_AUTH_INTEGRATION_COMPLETE.md)
...
- [`docs/3.2/3.2.4-Multichain-and-DEX/ZionDex-OnChain-Settlement-Plan.md`](3.2.4-Multichain-and-DEX/ZionDex-OnChain-Settlement-Plan.md)
- [`docs/3.2/3.2.4-Multichain-and-DEX/ZionDexZis.md`](3.2.4-Multichain-and-DEX/ZionDexZis.md)
...
- [`docs/3.2/3.2.5-OASIS-Web-and-Marketplace/oasis.md`](3.2.5-OASIS-Web-and-Marketplace/oasis.md)
- [`docs/3.2/3.2.5-OASIS-Web-and-Marketplace/ESHOP_WORKFLOW_PLAN.md`](3.2.5-OASIS-Web-and-Marketplace/ESHOP_WORKFLOW_PLAN.md)
- [`docs/3.2/3.2.5-OASIS-Web-and-Marketplace/RastaTheme.md`](3.2.5-OASIS-Web-and-Marketplace/RastaTheme.md)
- [`docs/3.2/3.2.5-OASIS-Web-and-Marketplace/logo.md`](3.2.5-OASIS-Web-and-Marketplace/logo.md)
...
- [`docs/3.2/L5_L6_ACTIVATION_PLAN.md`](L5_L6_ACTIVATION_PLAN.md)
...
- [`docs/3.2/3.2.7-Security-and-Audit/SECURITY.md`](3.2.7-Security-and-Audit/SECURITY.md)
- [`docs/3.2/SECURITY_AUDIT_3.2.md`](SECURITY_AUDIT_3.2.md)
...
- [`docs/3.2/3.2.8-Reset-Migration-and-Tooling/HARD_RESET_PLAYBOOK.md`](3.2.8-Reset-Migration-and-Tooling/HARD_RESET_PLAYBOOK.md)
...
- [`docs/3.2/3.2.9-Release-Launch-and-Community/OneLoveV3.2.md`](3.2.9-Release-Launch-and-Community/OneLoveV3.2.md)
- [`docs/3.2/3.2.9-Release-Launch-and-Community/DEEKHAONELOVE.md`](3.2.9-Release-Launch-and-Community/DEEKHAONELOVE.md)
- [`docs/3.2/3.2.9-Release-Launch-and-Community/CODE_OF_CONDUCT.md`](3.2.9-Release-Launch-and-Community/CODE_OF_CONDUCT.md)
- [`docs/3.2/3.2.9-Release-Launch-and-Community/CONTRIBUTING.md`](3.2.9-Release-Launch-and-Community/CONTRIBUTING.md)
...
- **Kanon / ústava / evidence:** [`docs/WP-Mainet/MiseAmenti/`](../WP-Mainet/MiseAmenti/README.md)
- **Narativní kniha a filosofická vrstva:** [`docs/WP-Mainet/nirvana/`](../WP-Mainet/nirvana/00-README.md) a [`docs/WP-Mainet/NirvanaCloud/`](../WP-Mainet/NirvanaCloud/00-README.md)
...
- 3.1 (V31 Mainnet Alpha): [`docs/3.1/PLAN_TO_3.1_RECONCILED.md`](../3.1/PLAN_TO_3.1_RECONCILED.md) a [`docs/3.1/REPORTS/`](../3.1/REPORTS/)
- 3.0.x: [`docs/3.0.9/`](../3.0.9/), [`docs/3.0.8/`](../3.0.8/) atd.