...
- `docs/WP-Mainet/BodhiGaia/` — **DRAFT** narrative + L5 truth anchor (Kniha Země): unifies the six communities, protocols of Earth, OASIS/web mirror, onboarding to L5, and a full L5 evidence registry with status of every claim and known discrepancies to fix. Companion to this plan; does not supersede it.
