...
**Jak na to:**
1. Jdi na [sepolia.basescan.org/address/0x487D87E243f87b1DDEEDEB890c40F2cEcCf67913#writeContract](https://sepolia.basescan.org/address/0x487D87E243f87b1DDEEDEB890c40F2cEcCf67913#writeContract)
...
5. Odměny vybeř kdykoli: funkce `claimRewards()`
...
- [DEFI.md](DEFI.md) — Technická dokumentace DeFi (pro vývojáře)
- [WARP.md](WARP.md) — Technická dokumentace bridge (pro vývojáře)
