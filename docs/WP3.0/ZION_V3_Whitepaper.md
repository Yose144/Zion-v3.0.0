...
**Primary strategic envelope:** **8,500,000,000 ZION** is dedicated to L4 OASIS/game development and game-economy bootstrap (4.95B direct OASIS slots + 3.3B L5 Free World Projects + 0.25B ecosystem allocation for game-dev execution).

| # | Allocation | ZION | Purpose |
|---|-----------|------|---------|
| 1-3 | OASIS Golden Egg | 4,950,000,000 | L4 game world reward pool (3 slots × 1.65B, 10-year vesting) |
| 4-5 | L5 Free World Projects | 3,300,000,000 | L5 Free World Projects (2 × 1.65B, 10-year vesting) — Slots 4 & 5 repurposed from OASIS to L5 |
| 6 | L6 Issobella — Orbital Station & Quantum Research Fund | 2,500,000,000 | Repurposed from DAO Treasury (Community Governance); locked until block 144,000 |
| 7 | DAO Grants & Bounties | 1,000,000,000 | Developer grants; locked until block 144,000 |
| 8 | DAO Ecosystem Bootstrap | 500,000,000 | Ecosystem development (includes game-dev execution envelope); locked until block 144,000 |
...
| 13 | Bridge Seed Fund | 400,000,000 | EVM bridge liquidity |
| 14 | Bridge Vault UTXO | 100,000,000 | Bridge unlock liquidity |

**DAO Treasury & L6 Issobella time-lock:** All 4,000,000,000 ZION in slots #6–8 (L6 Issobella 2.5B + DAO Treasury 1.5B) is locked until block height **144,000** (~100 days after genesis).
...
> Former slot 6 — Community Governance main (2,500,000,000 ZION) — was repurposed to **L6 Issobella — Orbital Station & Quantum Research Fund**; it remains locked until block 144,000.
