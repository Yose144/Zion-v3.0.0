...
| CHv4 produkční upgrade | Activation policy + production E2E CHv4 | BLOCKED | `docs/2.9.7/MAINNET_READINESS_UNIFIED.md` | B-CRIT-01 |
| Revenue produkční aktivace | Wallets + buyback limity + 72h canary | BLOCKED | `docs/2.9.7/MAINNET_READINESS_UNIFIED.md` | B-CRIT-02 |
