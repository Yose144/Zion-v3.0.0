...
> **Autor:** Devin  
> **Verze:** 1.0  
> **Status:** historický plán pro dokončení V31 / 3.1.0 Mainnet Alpha (2026-08-04). Aktuální plán na 3.2.0 "One Love" je [`V31/PLAN_TO_3.2.md`](../../V31/PLAN_TO_3.2.md) / [`OneLoveV3.2.md`](../3.2/3.2.9-Release-Launch-and-Community/OneLoveV3.2.md).  
...
| 4 | **DEX / ZionDex** | Multichain `/v1/swap/pools` OK, WARP HTLC smoke pass | DEX je basic AMM router, chybí intent-based settlement, solver network, TypeScript SDK, Solidity contracts | `zion-multichain::swap::dex` má constant-product AMM, multi-hop quote, bridge pooly a nový `intent` modul (SwapIntent, SolverBid, IntentAuction). Zbývá solver network, on-chain execution, TS SDK a Solidity contracts. |
