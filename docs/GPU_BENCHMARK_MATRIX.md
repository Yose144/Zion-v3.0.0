...
| RTX 3060 | Ampere (SM 8.6) | 12 GB GDDR6 | 360 | 8.6 | **2.6** ¹ | — | — | — | — |
...
¹ RTX 2060S and 3060 were benchmarked in an earlier session with pool overhead — numbers are lower bound (effective pool rate, not pure GPU).  
...
### 1. TPB=48 is universally optimal for CUDA
- Wins on Pascal (1060 3GB), Blackwell (5070 Ti), and ties on Ampere (A100).
- GTX 1080 is the exception: TPB=256 matches TPB=48 due to larger register file per SM.
...
```
Best $/KH:  GTX 1080     @ $0.048/hr → 198 KH/$
Runner-up:  RTX 5070 Ti  @ $0.10/hr  → 210 KH/$
Worst $/KH: A100 SXM4    @ $0.62/hr  → 62 KH/$
```
**GTX 1080 and RTX 5070 Ti are the cost-optimal choices** for cloud mining.
A100 gives raw power (38.5 KH/s) but at 3× worse cost efficiency.
...
| 8 GB (1080, 3060 Ti) | 48 | 16384 | 256 also works |
| 12 GB (3060, 3080) | 48 | 32768 | |
