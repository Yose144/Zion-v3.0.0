...
## 2. Kurukšétra — bojiště pochybnosti

Ardžuna stojí před bitvou. Na druhé straně jsou jeho příbuzní, učitelé, přátelé. Zná je. Miluje je. A přesto ví, že stojí na straně systému, který je třeba transformovat.
...
## 3. Kršnova odpověď — nishkama karma

Kršna neodpovídá povzbuzením ani sliby vítězství. Odpovídá filosofickým argumentem o **povaze činu bez připoutanosti k výsledku**.

*„Máš právo konat čin, ne na jeho plody. Nechej se pohánět činem, nikoli jeho ovocem. A nevyhýbej se činu nečinností."* (BG 2.47)

*Nishkama karma* — čin bez sobeckého záměru — je klíčový koncept Gíty. Neznamená lhostejnost k výsledku. Znamená, že **motivace činu** nesmí být osobní zisk, strach nebo ego. Čin má být proveden proto, že je správný — ne proto, aby přinesl konkrétní odměnu.

V kontextu mining a sítě: každý hash je validní bez ohledu na to, zda konkrétní blok vyhraje. Síť funguje na základě milionů aktů bez záruky individuální odměny. Nishkama karma jako princip sítě.

---

## 4. Tři cesty (jógy) — tři přístupy ke stavbě
...
Gíta netvrdí, že jedna cesta je nadřazená. Různí lidé dosáhnou správného činu různými cestami. Projekt potřebuje všechny tři — inženýry, architekty i komunitní správce — a každý přistupuje ke svému úkolu jiným způsobem.

---

## 5. Dharma — povinnost, která není libovolná

*Dharma* v kontextu Gíty není pravidlo zvenčí. Je to **vnitřní zákon existence** — to, co věc je ve své podstatě. Voda má dharmu být tekutá. Oheň má dharmu svítit a hřát.
...
## 6. Nesmrtelnost duše — a trvanlivost záměru

Jeden z nejcitovanějších úseků Gíty je o nesmrtelnosti duše:

*„Nikdy se nenarodil a nikdy nezemře. Je nezrozený, věčný, vždy existující a prvotní. Není zabit, když je tělo zabito."* (BG 2.20)
...
## 7. Šestnáctá kapitola — božská a démonická příroda

Gíta ve 16. kapitole rozlišuje mezi **daivī sampat** (božská přirozenost) a **āsurī sampat** (démonická přirozenost). Ne jako ontologické kategorie lidí — ale jako vzorce chování.

| Božská přirozenost | Démonická přirozenost |
|-------------------|----------------------|
...
Toto rozlišení není absolutní soud o lidech — je to **diagnóza vzorců**. Projekt, který chce sloužit vědomí, si musí tyto vzorce pojmenovat a sledovat, kdy se v jeho kultuře vynořují.
...
Gíta je nejlepší, když ji člověk čte celou, ve chvíli pochybnosti, bez očekávání, že dostane hotovou odpověď.
