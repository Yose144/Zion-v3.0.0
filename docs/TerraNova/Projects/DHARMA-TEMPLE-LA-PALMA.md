# Dharma Temple — L5 Komunita Terra Nova
*Spirituální centrum a off-grid komunita · La Palma, Kanárské ostrovy*

## Základní data

| Pole | Hodnota |
|------|---------|
| **Lokace** | La Palma, Kanárské ostrovy, Španělsko |
| **Klimatická zóna** | Subtropická oceánská — věčné jaro, 700–1 500 mm srážek/rok, vulkanická půda |
| **GPS / Oblast** | TBD |
...
### Energie
- **Zdroj:** Solar + mikrohydro (La Palma má nadbytek srážek a výškový rozdíl vhodný pro průtočné turbíny)
- **Kapacita cíl:** Plná off-grid soběstačnost
- **Záložní:** Baterie + přírodní chlazení
- **Status:** 🔵 Plánováno

### Voda
- **Zdroj:** Srážky (vydatné), případně pramenitá voda
- **Sběr dešťové vody:** Primární systém — kapacita cíl min. 50 m³
- **Čištění:** Přírodní multi-stage filtrace (sand + UV)
- **Status:** 🔵 Plánováno

### Jídlo a zahrada
- **Zahrada:** Syntropic agroforestry — vícevrstvý systém (stromy, keře, byliny, krytí půdy)
- **Vulkanická půda:** Extrémně úrodná — La Palma je jednou z nejúrodnějších půd Atlantiku
- **Produkty:** Tropické ovoce (banány, avokádo, cherimoya, papája), zelenina, bylinky
- **Soběstačnost cíl:** 70 % kalorií z vlastní produkce (fáze 3)
- **Status:** 🔵 Plánováno

### Ubytování
- **Typ:** Eco-cabins + meditační buňky (jedno- nebo dvoulůžkové, minimalismus)
- **Kapacita cíl:** 15–25 osob (8–12 stálých + hosté na retreaty)
- **Architektura:** Přirozené materiály — kámen, bambus, zemité omítky
- **Status:** 🔵 Plánováno
...
|----------|--------|----------|
| Meditace a ticho | 🔵 Plánováno | Denní praxe, silence retreaty |
| Syntropic zahrada | 🔵 Plánováno | Výukový model pro ostatní L5 uzly |
| Tělesná praxe | 🔵 Plánováno | Jóga, pohyb, práce v přírodě |
| Vzdělávání | 🔵 Plánováno | Workshopy: permakultura, governance, ZION |
| Dharma circle | 🔵 Plánováno | Komunitní rozhovory, sdílení |
| ZION node | 🔵 Plánováno | Guardian uzel sítě |
| Medical Table | 🔵 Plánováno | Holistický přístup ke zdraví |
| LoRa / Mesh | 🔵 Plánováno | Off-grid komunikace |
| Seed library | 🔵 Plánováno | Místní odrůdy + výměna s Zahradou Genesis |
| Kreativní dílna | 🔵 Plánováno | Keramika, tkaní, místní řemesla |
...
- **Rozhodování:** Konsensuální — církulární governance bez hierachie
- **ZION DAO:** Plánováno — hlasování o společných rozhodnutích on-chain
- **Minimální buňka:** 5–8 zakládajících Guardians se záměrem dlouhodobé praxe
- **Přijímání nových členů:** DAO hlasování + probační pobyt (30 dní)
...
| Seed Library Exchange | 🔵 Sdílení se Zahradou Genesis |
| Knowledge Commons | 🔵 Syntropic + governance dokumentace |
...
| Fáze | Cíl | Status |
|------|-----|--------|
| 0 — Zárodek | Identifikace pozemku, legal základ, core Guardians | 🔵 Zahájení |
| 1 — Kořeny | Solar, voda, základní ubytování, zahrada | 🔵 Plánováno |
| 2 — Komunita | Stálí obyvatelé, denní praxe, ZION node | 🔵 Plánováno |
| 3 — Síť | Propojení se Zahradou Genesis, Rhizom síť | 🔵 Plánováno |
| 4 — Výzařování | Retreaty, výukové programy, mezinárodní hosté | 🔵 Vize |

---

## Charakter místa — La Palma

La Palma je nazývána *"La Isla Bonita"* — Krásný ostrov. Je to nejzelenější z Kanárských ostrovů, s bioreservací UNESCO, národním parkem Caldera de Taburiente a noci tak tmavými, že tu stojí jedno z nejlepších observatoří světa.

Vulkanická energie ostrova není metafora — je to fyzická realita. Půda z černé lávy uchovává teplo, drží vlhkost a je tak úrodná, že stromy tu rostou jako zázrakem. Voda teče z hor. Vítr přináší mraky z Atlantiku. Místo má přirozené podmínky pro život, které by v kontinentální Evropě trvalo dekády vybudovat.

Dharma Temple tento dar nepovažuje za výhodu, ale za **odpovědnost** — starat se o místo s takovou péčí, s jakou se o nás stará ono.
...
- [ ] Konkrétní lokace na La Palmě (sever / jih / nadmořská výška?)
- [ ] Identifikace pozemku — koupit / pronajmout / spoluvlastnictví?
- [ ] Zakládající Guardians — kdo je core team?
- [ ] Právní forma (španělská asociación / SL / komunitní nadace?)
- [ ] Propojení s existujícími ekokomunitami na La Palmě
- [ ] Financování fáze 0–1 (ZION fond? crowdfunding? vlastní zdroje?)
- [ ] Certifikace biodynamické / organické zemědělství (SEAE?)
- [ ] Koordinace seed library s Zahradou Genesis
...
- **Koordinátor:** TBD
- **Kontaktní osoba:** TBD
- **Referenční projekty La Palma:** [Finca Inagua](https://www.fincainagua.com/), lokální agroekologická síť
