...
🏛️ Atlantis Circle (10) — Plato *Critias/Timaeus* literární mýtus, **ne historie**; `docs/TerraNova/atlantis`
...
### **51. Dalai Lama XIV** (Tenzin Gyatso)
...
### **27. Serapis Bey** (White Ray Master)
**Ray:** White (Purity/Ascension)
...
### **35. Karel IV** (Holy Roman Emperor)
...
## 🏛️ ATLANTIS CIRCLE — LITERÁRNÍ PLATÓN (*Critias*) (10 Avatars)

> Viz [`docs/TerraNova/atlantis/KONCEPT-AVATARI-OASIS.md`](../../TerraNova/atlantis/KONCEPT-AVATARI-OASIS.md) — **není to historický claim** · **žádné ancient-aliens pyramid NFT** · genealogická jména z dialogu jako governance pedagogika.

### **152. Atlas** (Ring steward / eldest king frame)
**Ray:** Azure + Gold · **Role:** multi-region consensus hubris check · **Quest:** Ring Steward Audit · **Ability:** Axis Lock Beacon · **CL:** 5–9 · **NFT:** Epic + classics disclaimer metadata

### **153. Cleito** (*Kleitó* sanctuary consent)
**Ray:** Pearl + Moss · **Role:** transparent charter / anti-stealth governance patch · **Quest:** Moat Charter Draft · **Ability:** Sanctuary Pause · **CL:** 4–8 · **NFT:** Epic + anti-fetish portrayal review

### **154. Gadeirus** (Harbor-ring / strait ethics)
**Ray:** Aqua + Bronze · **Role:** bridge etiquette & fair port fees lore · **Quest:** Strait Handshake Trials · **Ability:** Tithe Gate Buffer · **CL:** 4–9 · **NFT:** Epic disclaimer

### **155. Ampheres** (Proportional loadshare)
**Ray:** Slate + Amber · **Role:** emissions / subsidy fairness vignettes · **Quest:** Load Shed Covenant · **Ability:** Equity Ripple · **CL:** 3–8 · **NFT:** Rare

### **156. Evaemon** (Good-custom law etiquette)
**Ray:** Ivory + Indigo · **Role:** fork etiquette / community conduct teaching · **Quest:** Fork Etiquette Theater · **Ability:** Grace Window · **CL:** 2–7 · **NFT:** Rare

### **157. Mneseus** (Chain memory archives)
**Ray:** Bronze + Indigo · **Role:** changelog integrity debates · **Quest:** Ledger Lineage Exhibit · **Ability:** Replay Oracle · **CL:** 4–9 · **NFT:** Epic

### **158. Autochthon** (Local-first legitimacy)
**Ray:** Jade + Slate · **Role:** biome / local-node sovereignty folklore · **Quest:** Soil-signed Charter · **Ability:** Rooted Resilience · **CL:** 3–8 · **NFT:** Rare

### **159. Elasippus** (Routing cadence fairness)
**Ray:** Coral + Indigo · **Role:** mempool / throughput pedagogy sans barbarism caricature · **Quest:** Harbor Rhythm Puzzle · **Ability:** Throttle Charm · **CL:** 3–8 · **NFT:** Rare

### **160. Mestor** (Accord mediator)
**Ray:** Lavender + Bronze · **Role:** facilitator between stakeholder rings · **Quest:** Dual Ring Summit · **Ability:** Compromise Glyph · **CL:** 4–9 · **NFT:** Epic

### **161. Azaes** (Risk-bound explorer)
**Ray:** Crimson + Aqua · **Role:** graceful stress-test island narrative · **Quest:** Azimuth Stress Test Island · **Ability:** Boundary Ping · **CL:** 5–9 · **NFT:** Epic hubris-education tag

---

## 🌫️ LEMURIA CIRCLE — SYNTETICKÁ PEDAGOGIKA (10 Avatars)

> Viz [`docs/TerraNova/lemuria/KONCEPT-AVATARI-OASIS.md`](../../TerraNova/lemuria/KONCEPT-AVATARI-OASIS.md) — **hypotetický kontinent Lemuria není vědecký fakt** · **žádné root-races / Mu** · **Pacifik jen jako rámec solidarity**, ne jako náhrada domorodých výpovědí.

### **162. Lemur Steward** (Biodiversity-before-babel Madagascar frame)
**Ray:** Jade + Bronze · **Role:** primát / ekosystém priorita nad conspiracy economy · **Quest:** Phantom vs Field Notes · **Ability:** Primate Clarity Buff · **CL:** 3–8 · **NFT:** Rare + env donate tag suggested

### **163. Sclater Bridge** (Hypothesis retractions pedagogy)
**Ray:** Pewter + Pearl · **Role:** humility of obsolete maps · **Quest:** Hall of Retracted Hypotheses · **Ability:** Paper Recall Aura · **CL:** 4–9 · **NFT:** Rare (no heroic scientist cult art)

### **164. Coral Notary** (Reef accountability witness)
**Ray:** Aqua + Coral · **Role:** coral stress vs DAO witness metaphor · **Quest:** Bleach Event Tribunal · **Ability:** Symbiosis Witness · **CL:** 4–9 · **NFT:** Epic + climate org tagging

### **165. Tide Column** (Fair tidal rhythm / mempool equity lore)
**Ray:** Indigo + Slate · **Role:** small participant fairness arcs · **Quest:** High Tide Liquidity Fairshare · **Ability:** Ebb Rebate · **CL:** 3–8 · **NFT:** Rare

### **166. Basalt Chronicle** (MORB / ridge basalt geology honesty)
**Ray:** Slate + Crimson · **Role:** lithosphere pacing without Atlantis grind · **Quest:** Basalt Classroom Trail · **Ability:** Stratum Proof · **CL:** 4–9 · **NFT:** Rare

### **167. Foam Seed** (Dispersal ethics without colonial map)
**Ray:** Fog + Ivory · **Role:** onboarding consent vs settlers fantasy · **Quest:** Foam Landing Consent Pack · **Ability:** Drift Brake · **CL:** 3–8 · **NFT:** Rare

### **168. Oceanic Bridge** (Pacific solidarity scaffold)
**Ray:** Aqua + Indigo · **Role:** alliances without overwriting Indigenous arcs · **Quest:** Relay Fleet Without Theft · **Ability:** Solidarity Lantern · **CL:** 4–9 · **NFT:** Epic + cross-consult metadata

### **169. Shelf Whisper** (Shelf subsidence realism)
**Ray:** Indigo + Plum · **Role:** coastline risk truth-telling · **Quest:** SLR Scenario Tabletop · **Ability:** Bathyal Shield · **CL:** 5–9 · **NFT:** Epic

### **170. Equinox Lull** (Volatility moderation at thresholds)
**Ray:** Ivory + Indigo · **Role:** DAO timelock / panic dampening folklore · **Quest:** Equinox Voting Cooldown Ritual · **Ability:** Libration Hush · **CL:** 3–8 · **NFT:** Rare

### **171. Circle Closure** (Meta-bridge tee to cosmic wave)
**Ray:** Void + Violet · **Role:** handoff narration to cosmology archetypes **#172+** · **Quest:** Handoff Constellation Stub · **Ability:** Next-Wave Invitation *(cosmetic unlock, no race-coded art)* · **CL:** 4–9 · **NFT:** Mythic + zero hierarchic trope audit

---

## 🌠 COSMIC / VZESTUP CIRCLE — METAFORY VĚDOMÍ (10 Avatars)

> Viz [`docs/TerraNova/cosmic/KONCEPT-AVATARI-OASIS.md`](../../TerraNova/cosmic/KONCEPT-AVATARI-OASIS.md) + [`GALAKTICKA_FEDERACE.md`](../../TerraNova/cosmic/GALAKTICKA_FEDERACE.md) — **instituční hierarchie galaktického lore** jen zde. **COSMIC MAP** v `docs/docs2.9/` · **ne medicína** · archiv Vzestup: `APP&WEB/public_html/V2/Vzestup/` (mimo jiné `f_plamen/`; živé tsl.org URL se mohly změnit).

### **172. Great Central Sun Steward** (Cosmic clock / consensus frame)
**Ray:** Gold + White · **Role:** single logical tempo / DAO alignment lore · **Quest:** Radial Sync Briefing · **Ability:** Corona Consensus Pulse · **CL:** 5–9 · **NFT:** Legendary + non-medical metadata

### **173. Photon Cadence** (Photon-belt gates as season pacing only)
**Ray:** Rainbow + Slate · **Role:** anti-hype burnout / ethical releases · **Quest:** Gate Rollout Ethics Table · **Ability:** Chromatic Cooldown · **CL:** 4–9 · **NFT:** Epic + DNA non-claim disclaimer

### **174. Solar Logos Dual** (Helios/Vesta-style dual signing metaphor)
**Ray:** Amber + Rose · **Role:** cold+hot multisig personalities · **Quest:** Helios-Vesta multisig lore · **Ability:** Twin Ray Buffer · **CL:** 4–9 · **NFT:** Epic

### **175. Telluric Soul Bridge** (Planetary soul bridge; cross #25 Lady Gaia)
**Ray:** Jade + Violet · **Role:** regen side arcs tied to Gaia storyline · **Quest:** Soil-RPC Handshake · **Ability:** Humus Handoff · **CL:** 3–8 · **NFT:** Epic + cross-story note

### **176. Tube-of-Light Sentinel** (OPSEC visual from Vzestup practice names)
**Ray:** Silver + Indigo · **Role:** wallet hygiene / scam resistance · **Quest:** Column Audit Walkthrough · **Ability:** Phishing Bloom Purge · **CL:** 3–8 · **NFT:** Rare + wellness non-claims

### **177. Radiant Spiral** (Guild XP spiral — not body claims)
**Ray:** Coral + Cyan · **Role:** reputation for mentoring not grind · **Quest:** Spiral Reputation refactor · **Ability:** Vortex Mentor Mark · **CL:** 2–9 · **NFT:** Rare

### **178. Seventh Ray Adjunct** (Violet frequency UI next to Saint Germain #26)
**Ray:** Violet + Pearl · **Role:** transmutation systems vs duplicate master · **Quest:** Stacked Violet Tutorial · **Ability:** Karma Scrub Cosmetic · **CL:** 4–9 · **NFT:** Epic + coexistence with #26

### **179. Galactic Convenor** (Galactic Federation parliament — tiered mandates, not Earth-ethnic ranking)
**Ray:** Indigo + Platinum · **Role:** inter-guild federation + institucionalizovaná hierarchie viz [`docs/TerraNova/cosmic/GALAKTICKA_FEDERACE.md`](../../TerraNova/cosmic/GALAKTICKA_FEDERACE.md) · **Quest:** Protocol Parliament Session (+ optional Federation Tier Audit) · **Ability:** Orbit Silence · **CL:** 4–9 · **NFT:** Epic + GF art/copy gate

### **180. Lightbody Scribe** (Journaling only — no therapeutic NFT)
**Ray:** Ivory + Teal · **Role:** privacy / delete-my-data lore · **Quest:** Right To Be Forgotten Constellation · **Ability:** Ledger Amnesia Token · **CL:** 2–8 · **NFT:** Rare + wellness disclaimer

### **181. Vzestup Capstone** (13th expansion decad closure → COSMIC_MAP)
**Ray:** Void + Gold · **Role:** doc hub pointer / meta navigation · **Quest:** Return Vector: COSMIC_MAP.md · **Ability:** Map Bookmark · **CL:** 6–9 · **NFT:** Mythic + meta only

---

## ⚔️ NORSE–CELTIC CIRCLE — SEVER A OSTROVY (10 Avatars)

> Viz [`docs/TerraNova/norse-celtic/KONCEPT-AVATARI-OASIS.md`](../../TerraNova/norse-celtic/KONCEPT-AVATARI-OASIS.md) + tradice [`01-RAMEC-A-ETIKA.md`](../../TerraNova/norse-celtic/01-RAMEC-A-ETIKA.md), [`02-NORSE-ZDROJE-VALHALLA-A-ZPUSOB-ZIVOTA.md`](../../TerraNova/norse-celtic/02-NORSE-ZDROJE-VALHALLA-A-ZPUSOB-ZIVOTA.md), [`03-KELTICKE-SPEKTRUM-A-PRAMENY.md`](../../TerraNova/norse-celtic/03-KELTICKE-SPEKTRUM-A-PRAMENY.md). **Valhalla / einherjar** jen jako **guild + fair-play** metafora — žádná posmrtná rekrutace · žádná rasová pýcha / neonacistické runy · **Král Artuš [#23]** zůstává samostatný core odkaz.

### **182. Valhalla Hall-Steward** (Einherjar etiquette / rest cycle — not afterlife theology)
**Ray:** Amber + Steel · **Role:** guild hall host + anti-burnout pacing · **Quest:** Einherjar Etiquette Table · **Ability:** Roast-Rest Cycle · **CL:** 4–9 · **NFT:** Epic + Heathenry-informed consult

### **183. Óðinn Wayfarer** (Governance raven-log / fork review)
**Ray:** Indigo + Charcoal · **Role:** multisig wisdom + public argument · **Quest:** Huginn Diff / Muninn Merge · **Ability:** One-Eye Focus · **CL:** 5–9 · **NFT:** Legendary + hate-symbol ban on runes

### **184. Þórr Storm-Host** (Uptime / community safety — not toxic alpha trope)
**Ray:** Storm Grey + Mjolnir Gold · **Role:** infra resilience + rate limits · **Quest:** Mjölnir Rate-Limit · **Ability:** Chain Lightning Purge · **CL:** 3–9 · **NFT:** Epic

### **185. Freyja Van-Ruler** (Fair treasury + privacy lore — no sexualized combat)
**Ray:** Rose + Gold · **Role:** escrow fairness + encryption metaphor (seiðr as data care) · **Quest:** Brisingamen Escrow · **Ability:** Falcon Trace · **CL:** 4–9 · **NFT:** Epic + metadata parity check

### **186. Týr Oath-Fire** (Timelock sacrifice / smart-contract honor)
**Ray:** Crimson + Slate · **Role:** oath-bound upgrades · **Quest:** Fenrir Timelock · **Ability:** Oath-Burn Seal · **CL:** 5–9 · **NFT:** Rare

### **187. Brigid Triple-Flame** (Forge / docs / care — syncretism disclaimer)
**Ray:** White + Forge Orange · **Role:** open tooling + translations · **Quest:** Forge Docs Sprint · **Ability:** Triple-Wick Focus · **CL:** 2–8 · **NFT:** Epic + non-medical wellness

### **188. Dagda Peace-Harp** (Public goods / epoch spacing)
**Ray:** Green + Bronze · **Role:** sustainable emissions + commons refill · **Quest:** Undry Cauldron Refill · **Ability:** Harp Lull · **CL:** 3–9 · **NFT:** Epic

### **189. Morrígan Sovereignty-Raven** (Threat triage — mandatory art consult)
**Ray:** Black + Blood Red · **Role:** responsible disclosure + governance veto vs attacks · **Quest:** Battle Crow Triage · **Ability:** Phantom Stratagem · **CL:** 6–9 · **NFT:** Mythic + Kālī-tier art gate

### **190. Lugh Samildanach** (Multi-skill multisig / mentor rotation)
**Ray:** Gold + Copper · **Role:** cross-stack competence without hero worship · **Quest:** Tailtiu Field Day · **Ability:** Many-Skill Attune · **CL:** 3–9 · **NFT:** Epic

### **191. Manannán mac Lir** (Sandbox / mist boundaries between chains)
**Ray:** Sea Teal + Fog Silver · **Role:** testnet isolation + feature flags · **Quest:** Cloak of Nine Shadows · **Ability:** Mist Veil · **CL:** 4–9 · **NFT:** Rare + no Atlantis conflation
