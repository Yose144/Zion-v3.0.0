...
**WARP status:** Běží na Edge (port 9333), 13 chain family adapterů implementováno (EVM, BTC, Solana, Tron, Stellar, Cosmos, Cardano, Lightning, Aptos, NEAR, Sui, TON), 465 testů pass. 13 adapterů plně funkčních (EVM, BTC, SOL, TRX, XLM, Cosmos, Cardano CBOR TX, Lightning, NEAR, Aptos BCS TX, Sui BCS TX). TON potřebuje TL-B SDK. Lightning potřebuje LND node na Edge.
