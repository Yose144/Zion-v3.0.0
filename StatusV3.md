...
| autolykos | ERG | 82M | **18.4B** | ✅ **CPU/GPU MATCH** ~25.35 MH/s (R table optimized, height=0); v1 tableless 14.37 MH/s → v2 R table 21 MH/s → v3 optimized 25.35 MH/s; `b7fc2a180` |
