...
| XMR | randomx | Stratum | ✅ Native RandomX (tevador/RandomX, JIT + HW AES + AVX2 + huge pages, per-thread VM, 161 H/s 4-core EPYC vs XMRig 245 H/s). Pool E2E: MoneroOcean reachable (gulf.moneroocean.stream:10001), login+authorize+job received OK. Shares rejected "Low difficulty share" — target/difficulty mismatch under investigation. See [`docs/3.0.5/RANDOMX_PERF_OPTIMIZATION_2026-07-16.md`](./docs/3.0.5/RANDOMX_PERF_OPTIMIZATION_2026-07-16.md) |
