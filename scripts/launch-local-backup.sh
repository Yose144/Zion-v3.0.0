...
P1=$!
echo "Started Backup Node  PID=$P1 (seeding from 62.171.141.136:8333)"
sleep 3
...
PM=$!
echo "Started Miner CPU (1 thread)  PID=$PM -> Edge pool 62.171.141.136:8444"
sleep 1
...
PG=$!
echo "Started Miner GPU (OpenCL)    PID=$PG -> Edge pool 62.171.141.136:8444"
...
echo ""
echo "[topology] Edge (62.171.141.136) = primary node + pool"
