...
[Environment]::SetEnvironmentVariable('ZION_NODE_STATE_PATH', 'C:\Users\yosef\AppData\Local\Temp\zion-node2-state.db', 'Process')
...
# Clean persisted peers for fresh bootstrap
