...
[Environment]::SetEnvironmentVariable('ZION_NODE_STATE_PATH', 'C:\Users\yosef\AppData\Local\Temp\zion-node-state.db', 'Process')
...
# Clean persisted peers so empty seed_peers truly means no bootstrap peers
