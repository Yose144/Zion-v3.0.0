...
# TeamRedMiner ID (standard AMD miner)
TEAMREDMINER_ID = 2
TEAMREDMINER_ZANO = '--disable-cpu --algorithm progpow_zano --pool fr.zano.herominers.com:1110 --wallet ZxCj5kQhNdW7xtt4hDTotBPGUsWYKRdtdPTFXjzFpPpf6q42rCVXcYnTtHRYGj3pzz2LUqCnvVoRzFn9zfZdCSzC1CkBiHYrg --api-enable'
...
print('>> FORCE: set TeamRedMiner by ID with ZANO options')
api('PUT', f'/rig-groups/{GROUP}', {
    'customMiner': '',
    'minerId': TEAMREDMINER_ID,
    'minerOptions': TEAMREDMINER_ZANO
})
time.sleep(2)
