...
Status date: **2026-07-27** (3.0.7 "Trinity All Green" live after 2026-07-20 genesis reset — 14/15 services active, protocol zion-v3-node/3.0.7, chain height 7101+, E2E memo tests verified in block 752 — see supplement below)
...
Migration begins only after 3.0.9 is complete. See full plan: [`V3.1_MIGRATION_PLAN.md`](../docs/3.0.6/V3.1_MIGRATION_PLAN.md). Native integration seams (Bridge↔WARP, AuxPoW→Miner, ZionDex→L2): [`V3.1_INTEGRATION_PLAN.md`](../docs/3.0.6/V3.1_INTEGRATION_PLAN.md).
