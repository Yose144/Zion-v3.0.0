...
pub use hiranyagarbha::{
    HiranyagarbhaAgent, HiranyagarbhaIdentity, MmlInput, MmlModality, MmlOutput,
};
pub use in_context::{ContextAssembler, ContextSnapshot, InContextBackend};
pub use llm_backend::{
    ConsciousnessAwareBackend, EchoBackend, LlmBackend, LlmError, LlmRequest, LlmResponse,
};
...
pub use rag::{
    EmbeddingBackend, MockEmbeddingBackend, RagBackend, RagDocument, RagRetriever, VectorStore,
};
