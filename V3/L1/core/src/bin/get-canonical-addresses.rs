fn main() {
    ...
    let issobella_label = "ZION_V3_MAINNET_CANONICAL_ISSOBELLA_SUBSIDY_RECIPIENT_v2_2026-06-03-GENESIS-RESET";
    let pool_fee_label = "ZION_V3_MAINNET_CANONICAL_POOL_FEE_SUBSIDY_RECIPIENT_v2_2026-06-03-GENESIS-RESET";
    let default_miner_label = "ZION_V3_MAINNET_CANONICAL_DEFAULT_SOLO_MINER_COINBASE_v2_2026-06-03-GENESIS-RESET";
    let pool_payout_label = "ZION_V3_MAINNET_CANONICAL_POOL_PPLNS_PAYOUT_SIGNER_v2_2026-06-03-GENESIS-RESET";
