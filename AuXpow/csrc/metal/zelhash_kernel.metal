// ZelHash Metal kernel for FLUX mining.
//
...
//
// Translated from opencl/zelhash_kernel.cl.
...
constant const uint BLAKE2B_IV[8] = {
    0x6A09E667u, 0xBB67AE85u, 0x3C6EF372u, 0xA54FF53Au,
    0x510E527Fu, 0x9B05688Cu, 0x1F83D9ABu, 0x5BE0CD19u
};

constant const uchar BLAKE2B_SIGMA[12][16] = {
...
void blake2b_compress(
    ...
    for (int r = 0; r < 12; r++) {
        constant const uchar *s = BLAKE2B_SIGMA[r];
...
void zelhash_blake2b(
    ...
    h[0] = BLAKE2B_IV[0] ^ 0x666F6F72506C655AUL;  // "ZelProof" as LE ulong
    h[1] = BLAKE2B_IV[1] ^ 0x000000040000007DUL;   // 125 (0x7D) + 4 (0x04) as LE
...
uint extract_chunk(thread const uchar hash[64], uint chunk_idx) {
...
void compress_solution(
    thread const uint indices[EH_SOLUTION_INDICES],
    thread uchar solution[EH_SOLUTION_SIZE]
) {
...
kernel void zelhash_mine(
    ...
    device uint* found [[buffer(5)]],                 // found flag (0/1)
...
//
// This would require ~500-1000 lines of Metal and careful memory
